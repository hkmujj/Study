...
namespace Engine.TCMS.Turkmenistan.Constant
{
    public class ViewNames
    {
        ...
        public static readonly string RunParamPage1 = typeof(RunParamPage1).FullName;
        public static readonly string RunParamPage2 = typeof(RunParamPage2).FullName;
        public static readonly string RunParamPage3 = typeof(RunParamPage3).FullName;
        public static readonly string RunParamPage4 = typeof(RunParamPage4).FullName;
        public static readonly string RunParamPage5 = typeof(RunParamPage5).FullName;
        public static readonly string RunParamPage6 = typeof(RunParamPage6).FullName;
        public static readonly string RunParamPage7 = typeof(RunParamPage7).FullName;
