...
{
    [Serializable]
    public class SignalDataIn300H : SignalDataIn
    {
        /// <summary>
        /// 请求输入车次号
        /// </summary>
        public bool StartTrainNumAck { set; get; }
        /// <summary>
        /// 请求输入列车长度
        /// </summary>
        public bool StartTrainLengthAck { set; get; }
        /// <summary>
        /// 请求RBC呼叫失败
        /// </summary>
        public bool RBCConnectFailAck { set; get; }
        /// <summary>
        /// 请求制动测试失败
        /// </summary>
        public bool BrakeTestFailAck { set; get; }
