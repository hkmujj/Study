...
{
    public class ATP300HDriverInterfaceController : DriverInterfaceController
    {
        public ATP300HDriverInterfaceController(ATPDomain atp, IDriverInterfaceFactory factory,
