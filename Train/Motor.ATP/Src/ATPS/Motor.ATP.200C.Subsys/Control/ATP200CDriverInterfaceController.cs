...
{
    public class ATP200CDriverInterfaceController : DriverInterfaceController
    {
        public ATP200CDriverInterfaceController(ATPDomain atp, IDriverInterfaceFactory factory,
