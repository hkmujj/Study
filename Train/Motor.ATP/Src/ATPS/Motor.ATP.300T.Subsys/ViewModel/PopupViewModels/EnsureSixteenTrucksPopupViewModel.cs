...
{
    [Export]
    public class EnsureSixteenTrucksPopupViewModel : EnsureEventPopupViewModelBase
    {

        public EnsureSixteenTrucksPopupViewModel()
        {
            TitleContent = PopupViewStringKeys.StringTitleEnsureTrainMarshallingNumber;
            EnsurceContent = PopupViewStringKeys.StringEnsureSixteenTrucksContent;
        }
