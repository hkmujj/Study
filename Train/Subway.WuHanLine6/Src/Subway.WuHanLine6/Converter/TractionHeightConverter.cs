...
namespace Subway.WuHanLine6.Converter
{
    ...
    /// 牵引封锁界面行高
    /// </summary>
    public class TractionHeightConverter : IMultiValueConverter
    {
        /// <summary>
        /// 偏移
        /// </summary>
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var rowSpan = int.Parse(values[1].ToString());

            var allHeight = (double)values[0];

            var tempValue = (allHeight - Besize * Offset * 2) / Besize * rowSpan + (rowSpan - 1) * (Offset * 2);
