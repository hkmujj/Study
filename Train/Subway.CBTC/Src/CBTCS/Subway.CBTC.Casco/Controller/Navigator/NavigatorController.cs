...
using Subway.CBTC.Casco.Controller.Navigator.Maintence;
using Subway.CBTC.Casco.Controller.Navigator.Running;
using Subway.CBTC.Casco.View.Layout;
using Subway.CBTC.Casco.View.Maintence;
using Subway.CBTC.Casco.View.Running;

namespace Subway.CBTC.Casco.Controller.Navigator
{
    /// <summary>
