...
using Subway.CBTC.THALES.Constant;
using Subway.CBTC.THALES.Controller.Navigator.Maintence;
using Subway.CBTC.THALES.Controller.Navigator.Running;
using Subway.CBTC.THALES.View.Layout;

namespace Subway.CBTC.THALES.Controller.Navigator
{
    /// <summary>
