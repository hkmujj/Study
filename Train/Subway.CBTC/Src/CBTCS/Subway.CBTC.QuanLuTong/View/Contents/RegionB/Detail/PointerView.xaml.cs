...
namespace Subway.CBTC.QuanLuTong.View.Contents.RegionB.Detail
{
    /// <summary>
    ...
    public partial class PointerView
    {
        ...
        {
            get { return (Brush) this.GetValue(ContentBrushProperty); }
        ...
        {
            get { return (double) this.GetValue(PointerAngleProperty); }
            set { this.SetValue(PointerAngleProperty, value); }
        }
    }
}
