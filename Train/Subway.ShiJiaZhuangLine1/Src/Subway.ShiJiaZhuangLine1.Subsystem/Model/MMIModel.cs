...
namespace Subway.ShiJiaZhuangLine1.Subsystem.Model
{
    ...
    public class MMIModel : NotificationObject, IMMI, IDisposable
    {
        ...
        private EmergencyBrakeCauseModel m_EmergencyBrakeCauseModel;
        ...
        public void Init()
        {
            ...
            var ebs = ExcelParser.Parser<EmergencyBrakeCauseUnit>(appConfigDirectory);
            EmergencyBrakeCauseModel = ServiceLocator.Current.GetInstance<EmergencyBrakeCauseModel>();
            EmergencyBrakeCauseModel.EmergencyBrakeCauseUnits = new ObservableCollection<EmergencyBrakeCauseUnit>(ebs);
        ...
        public EmergencyBrakeCauseModel EmergencyBrakeCauseModel
        {
            get { return m_EmergencyBrakeCauseModel; }
            set
            {
                if (Equals(value, m_EmergencyBrakeCauseModel))
                    return;
                m_EmergencyBrakeCauseModel = value;
                RaisePropertyChanged(() => EmergencyBrakeCauseModel);
            }
        }
