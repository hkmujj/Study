...
namespace ES.Facility.PublicModule.Win32
{
    ...
    public struct ENUMLOGFONT
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = GDI.LF_FULLFACESIZE)]
    ...
    public struct EXTLOGFONT
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = GDI.ELF_VENDOR_SIZE)]
    ...
    public abstract class GDI
    {
        ...
        [DllImport("gdi32")]
        public static extern int AngleArc(HDC hdc, int x, int y, int dwRadius, double eStartAngle, double eSweepAngle);
        [DllImport("gdi32")]
        public static extern int AnimatePalette(HANDLE hPalette, int wStartIndex, int wNumEntries, PALETTEENTRY[] lpPaletteColors);
        [DllImport("gdi32")]
        public static extern int Arc(HDC hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32")]
        public static extern int ArcTo(HDC hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32")]
        public static extern int BeginPath(HDC hdc);
        [DllImport("gdi32")]
        public static extern int BitBlt(HDC hDestDC, int x, int y, int nWidth, int nHeight, HDC hSrcDC, int xSrc, int ySrc, int dwRop);
        [DllImport("gdi32")]
        public static extern int CancelDC(HDC hdc);
        [DllImport("gdi32")]
        public static extern int CheckColorsInGamut(HDC hdc, IntPtr lpv, IntPtr lpv2, int dw);
        [DllImport("gdi32")]
        public static extern int ChoosePixelFormat(HWND hdc, ref PIXELFORMATDESCRIPTOR pPixelFormatDescriptor);
        [DllImport("gdi32")]
        public static extern int Chord(HDC hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32")]
        public static extern int CloseEnhMetaFile(HDC hdc);
        [DllImport("gdi32")]
        public static extern int CloseFigure(HDC hdc);
        [DllImport("gdi32")]
        public static extern int CloseMetaFile(HANDLE hMF);
        [DllImport("gdi32")]
        public static extern int ColorMatchToTarget(HDC hdc, HWND hdc2, int dw);
        [DllImport("gdi32")]
        public static extern int CombineRgn(HANDLE hDestRgn, HANDLE hSrcRgn1, HANDLE hSrcRgn2, int nCombineMode);
        [DllImport("gdi32")]
        public static extern int CombineTransform(ref XFORM lpxformResult, ref XFORM lpxform1, ref XFORM lpxform2);
        [DllImport("gdi32")]
        public static extern int CopyEnhMetaFile(HANDLE hemfSrc, string lpszFile);
        [DllImport("gdi32")]
        public static extern int CopyMetaFile(HANDLE hMF, string lpFileName);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int CreateCompatibleBitmap(HDC hdc, int nWidth, int nHeight);
        [DllImport("gdi32")]
        public static extern int CreateCompatibleDC(HDC hdc);
        [DllImport("gdi32")]
        public static extern int CreateDC(string lpDriverName, string lpDeviceName, string lpOutput, ref DEVMODE lpInitData);
        [DllImport("gdi32")]
        public static extern int CreateDIBPatternBrush(HANDLE hPackedDIB, int wUsage);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int CreateDiscardableBitmap(HDC hdc, int nWidth, int nHeight);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int CreateEnhMetaFile(HWND hdcRef, string lpFileName, ref RECT lpRect, string lpDescription);
        [DllImport("gdi32")]
        public static extern int CreateFont(HANDLE h, int W, int E, int O, int W2, int I, int u, int S, int C, int OP, int CP, int Q, int PAF, string F);
        [DllImport("gdi32")]
        public static extern int CreateFontIndirect(ref LOGFONT lpLogFont);
        [DllImport("gdi32")]
        public static extern int CreateHalftonePalette(HDC hdc);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int CreatePatternBrush(HANDLE hBitmap);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int DPtoLP(HDC hdc, ref POINT lpPoint, int nCount);
        [DllImport("gdi32")]
        public static extern int DeleteColorSpace(HANDLE hcolorspace);
        [DllImport("gdi32")]
        public static extern int DeleteDC(HDC hdc);
        [DllImport("gdi32")]
        public static extern int DeleteEnhMetaFile(HANDLE hemf);
        [DllImport("gdi32")]
        public static extern int DeleteMetaFile(HANDLE hMF);
        [DllImport("gdi32")]
        public static extern int DeleteObject(HANDLE hObject);
        [DllImport("gdi32")]
        public static extern int DescribePixelFormat(HWND hdc, int n, int un, ref PIXELFORMATDESCRIPTOR lpPixelFormatDescriptor);
        [DllImport("gdi32")]
        public static extern int DrawEscape(HDC hdc, int nEscape, int cbInput, string lpszInData);
        [DllImport("gdi32")]
        public static extern int Ellipse(HDC hdc, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")]
        public static extern int EndDoc(HDC hdc);
        [DllImport("gdi32")]
        public static extern int EndPage(HDC hdc);
        [DllImport("gdi32")]
        public static extern int EndPath(HDC hdc);
        [DllImport("gdi32")]
        public static extern int EnumEnhMetaFile(HDC hdc, HANDLE hemf, ref int lpEnhMetaFunc, IntPtr lpData, ref RECT lpRect);
        [DllImport("gdi32")]
        public static extern int EnumFontFamilies(HDC hdc, string lpszFamily, ref int lpEnumFontFamProc, int lParam);
        [DllImport("gdi32")]
        public static extern int EnumFontFamiliesEx(HDC hdc, ref LOGFONT lpLogFont, ref int lpEnumFontProc, int lParam, int dw);
        [DllImport("gdi32")]
        public static extern int EnumFonts(HWND hdc, string lpsz, ref int lpFontEnumProc, int lParam);
        [DllImport("gdi32")]
        public static extern int EnumICMProfiles(HDC hdc, int icmEnumProc, int lParam);
        [DllImport("gdi32")]
        public static extern int EnumMetaFile(HWND hdc, HANDLE hMetafile, ref int lpMFEnumProc, int lParam);
        [DllImport("gdi32")]
        public static extern int EnumObjects(HWND hdc, int n, ref int lpGOBJEnumProc, IntPtr lpVoid);
        [DllImport("gdi32")]
        public static extern int EqualRgn(HANDLE hSrcRgn1, HANDLE hSrcRgn2);
        [DllImport("gdi32")]
        public static extern int Escape(HDC hdc, int nEscape, int nCount, string lpInData, IntPtr lpOutData);
        [DllImport("gdi32")]
        public static extern int ExcludeClipRect(HDC hdc, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int ExtEscape(HDC hdc, int nEscape, int cbInput, string lpszInData, int cbOutput, string lpszOutData);
        [DllImport("gdi32")]
        public static extern int ExtFloodFill(HDC hdc, int x, int y, int crColor, int wFillType);
        [DllImport("gdi32")]
        public static extern int ExtSelectClipRgn(HDC hdc, HANDLE hRgn, int fnMode);
        [DllImport("gdi32")]
        public static extern int ExtTextOut(HDC hdc, int x, int y, int wOptions, ref RECT lpRect, string lpString, int nCount, ref int lpDx);
        [DllImport("gdi32")]
        public static extern int FillPath(HDC hdc);
        [DllImport("gdi32")]
        public static extern int FillRgn(HDC hdc, HANDLE hRgn, HANDLE hBrush);
        [DllImport("gdi32")]
        public static extern int FixBrushOrgEx(HWND hdc, int n1, int n2, ref POINT lpPoint);
        [DllImport("gdi32")]
        public static extern int FlattenPath(HDC hdc);
        [DllImport("gdi32")]
        public static extern int FloodFill(HDC hdc, int x, int y, int crColor);
        [DllImport("gdi32")]
        public static extern int FrameRgn(HDC hdc, HANDLE hRgn, HANDLE hBrush, int nWidth, int nHeight);
        [DllImport("gdi32")]
        public static extern int GdiComment(HDC hdc, int cbSize, Byte lpData);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int GetBitmapBits(HANDLE hBitmap, int dwCount, IntPtr lpBits);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int GetBoundsRect(HDC hdc, ref RECT lprcBounds, int flags);
        [DllImport("gdi32")]
        public static extern int GetBrushOrgEx(HWND hdc, ref POINT lpPoint);
        [DllImport("gdi32")]
        public static extern int GetCharABCWidths(HDC hdc, int uFirstChar, int uLastChar, ref ABC lpabc);
        [DllImport("gdi32")]
        public static extern int GetCharABCWidthsFloat(HDC hdc, int iFirstChar, int iLastChar, ref ABCFLOAT lpABCF);
        [DllImport("gdi32")]
        public static extern int GetCharWidth(HDC hdc, int wFirstChar, int wLastChar, int[] lpBuffer);
        [DllImport("gdi32")]
        public static extern int GetCharWidth32(HDC hdc, int iFirstChar, int iLastChar, int[] lpBuffer);
        [DllImport("gdi32")]
        public static extern int GetCharWidthFloat(HDC hdc, int iFirstChar, int iLastChar, double[] pxBuffer);
        [DllImport("gdi32")]
        public static extern int GetCharacterPlacement(HDC hdc, string lpsz, int n1, int n2, ref GCP_RESULTS lpGcpResults, int dw);
        [DllImport("gdi32")]
        public static extern int GetClipBox(HDC hdc, ref RECT lpRect);
        [DllImport("gdi32")]
        public static extern int GetClipRgn(HDC hdc, HANDLE hRgn);
        [DllImport("gdi32")]
        public static extern int GetColorAdjustment(HDC hdc, ref COLORADJUSTMENT lpca);
        [DllImport("gdi32")]
        public static extern int GetColorSpace(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetCurrentObject(HDC hdc, int uObjectType);
        [DllImport("gdi32")]
        public static extern int GetCurrentPositionEx(HDC hdc, ref POINT lpPoint);
        [DllImport("gdi32")]
        public static extern int GetDCOrgEx(HDC hdc, ref POINT lpPoint);
        [DllImport("gdi32")]
        public static extern int GetDIBColorTable(HWND hdc, int un1, int un2, ref RGBQUAD pRGBQuad);
        [DllImport("gdi32")]
        public static extern int GetDIBits(int aHDC, HANDLE hBitmap, int nStartScan, int nNumScans, IntPtr lpBits, ref BITMAPINFO lpBI, int wUsage);
        [DllImport("gdi32")]
        public static extern int GetDeviceCaps(HDC hdc, int nIndex);
        [DllImport("gdi32")]
        public static extern int GetDeviceGammaRamp(HDC hdc, IntPtr lpv);
        [DllImport("gdi32")]
        public static extern int GetEnhMetaFile(string lpszMetaFile);
        [DllImport("gdi32")]
        public static extern int GetEnhMetaFileBits(HANDLE hemf, int cbBuffer, Byte lpbBuffer);
        [DllImport("gdi32")]
        public static extern int GetEnhMetaFileDescription(HANDLE hemf, int cchBuffer, string lpszDescription);
        [DllImport("gdi32")]
        public static extern int GetEnhMetaFileHeader(HANDLE hemf, int cbBuffer, ref ENHMETAHEADER lpemh);
        [DllImport("gdi32")]
        public static extern int GetEnhMetaFilePaletteEntries(HANDLE hemf, int cEntries, ref PALETTEENTRY lppe);
        [DllImport("gdi32")]
        public static extern int GetFontData(HDC hdc, int dwTable, int dwOffset, IntPtr lpvBuffer, int cbData);
        [DllImport("gdi32")]
        public static extern int GetFontLanguageInfo(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetGlyphOutline(HDC hdc, int uChar, int fuFormat, ref GLYPHMETRICS lpgm, int cbBuffer, IntPtr lpBuffer, ref MAT2 lpmat2);
        [DllImport("gdi32")]
        public static extern int GetGraphicsMode(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetICMProfile(HDC hdc, int dw, string lpStr);
        [DllImport("gdi32")]
        public static extern int GetKerningPairs(HDC hdc, int cPairs, ref KERNINGPAIR lpkrnpair);
        [DllImport("gdi32")]
        public static extern int GetLogColorSpace(HANDLE hcolorspace, ref LOGCOLORSPACE lplogcolorspace, int dw);
        [DllImport("gdi32")]
        public static extern int GetMapMode(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetMetaFile(string lpFileName);
        [DllImport("gdi32")]
        public static extern int GetMetaFileBitsEx(HANDLE hMF, int nSize, IntPtr lpvData);
        [DllImport("gdi32")]
        public static extern int GetMetaRgn(HDC hdc, HANDLE hRgn);
        [DllImport("gdi32")]
        public static extern int GetMiterLimit(HDC hdc, double peLimit);
        [DllImport("gdi32")]
        public static extern int GetNearestColor(HDC hdc, int crColor);
        [DllImport("gdi32")]
        public static extern int GetNearestPaletteIndex(HANDLE hPalette, int crColor);
        [DllImport("gdi32")]
        public static extern int GetObject(HANDLE hObject, int nCount, IntPtr lpObject);
        [DllImport("gdi32")]
        public static extern int GetObjectType(HANDLE hgdiobj);
        [DllImport("gdi32")]
        public static extern int GetOutlineTextMetrics(HDC hdc, int cbData, ref OUTLINETEXTMETRIC lpotm);
        [DllImport("gdi32")]
        public static extern int GetPaletteEntries(HANDLE hPalette, int wStartIndex, int wNumEntries, ref PALETTEENTRY lpPaletteEntries);
        [DllImport("gdi32")]
        public static extern int GetPath(HDC hdc, ref POINT lpPoint, Byte lpTypes, int nSize);
        [DllImport("gdi32")]
        public static extern int GetPixel(HDC hdc, int x, int y);
        [DllImport("gdi32")]
        public static extern int GetPixelFormat(HWND hdc);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int GetRegionData(HANDLE hRgn, int dwCount, ref RGNDATA lpRgnData);
        [DllImport("gdi32")]
        public static extern int GetRgnBox(HANDLE hRgn, ref RECT lpRect);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int GetSystemPaletteUse(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetTextAlign(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetTextCharacterExtra(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetTextCharset(HDC hdc);
        [DllImport("gdi32")]
        public static extern int GetTextCharsetInfo(HDC hdc, ref FONTSIGNATURE lpSig, int dwFlags);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int GetTextFace(HDC hdc, int nCount, string lpFacename);
        [DllImport("gdi32")]
        public static extern int GetTextMetrics(HDC hdc, ref TEXTMETRIC lpMetrics);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int GetWinMetaFileBits(HANDLE hemf, int cbBuffer, Byte lpbBuffer, int fnMapMode, HWND hdcRef);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int GetWorldTransform(HDC hdc, ref XFORM lpXform);
        [DllImport("gdi32")]
        public static extern int IntersectClipRect(HDC hdc, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")]
        public static extern int InvertRgn(HDC hdc, HANDLE hRgn);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int LineTo(HDC hdc, int x, int y);
        [DllImport("gdi32")]
        public static extern int MaskBlt(HWND hdcDest, int nXDest, int nYDest, int nWidth, int nHeight, HWND hdcSrc, int nXSrc, int nYSrc, HANDLE hbmMask, int xMask, int yMask, int dwRop);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int OffsetRgn(HANDLE hRgn, int x, int y);
        [DllImport("gdi32")]
        public static extern int OffsetViewportOrgEx(HDC hdc, int nX, int nY, ref POINT lpPoint);
        [DllImport("gdi32")]
        public static extern int OffsetWindowOrgEx(HDC hdc, int nX, int nY, ref POINT lpPoint);
        [DllImport("gdi32")]
        public static extern int PaintRgn(HDC hdc, HANDLE hRgn);
        [DllImport("gdi32")]
        public static extern int PatBlt(HDC hdc, int x, int y, int nWidth, int nHeight, int dwRop);
        [DllImport("gdi32")]
        public static extern int PathToRegion(HDC hdc);
        [DllImport("gdi32")]
        public static extern int Pie(HDC hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32")]
        public static extern int PlayEnhMetaFile(HDC hdc, HANDLE hemf, ref RECT lpRect);
        [DllImport("gdi32")]
        public static extern int PlayEnhMetaFileRecord(HDC hdc, ref HANDLETABLE lpHandletable, ref ENHMETARECORD lpEnhMetaRecord, int nHandles);
        [DllImport("gdi32")]
        public static extern int PlayMetaFile(HDC hdc, HANDLE hMF);
        [DllImport("gdi32")]
        public static extern int PlayMetaFileRecord(HDC hdc, ref HANDLETABLE lpHandletable, ref METARECORD lpMetaRecord, int nHandles);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int PolyDraw(HDC hdc, ref POINT lppt, Byte lpbTypes, int cCount);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int PolyTextOut(HDC hdc, ref POLYTEXT pptxt, int cStrings);
        [DllImport("gdi32")]
        public static extern int Polygon(HDC hdc, ref POINT lpPoint, int nCount);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int PtInRegion(HANDLE hRgn, int x, int y);
        [DllImport("gdi32")]
        public static extern int PtVisible(HDC hdc, int x, int y);
        [DllImport("gdi32")]
        public static extern int RealizePalette(HDC hdc);
        [DllImport("gdi32")]
        public static extern int RectInRegion(HANDLE hRgn, ref RECT lpRect);
        [DllImport("gdi32")]
        public static extern int RectVisible(HDC hdc, ref RECT lpRect);
        [DllImport("gdi32")]
        public static extern int Rectangle(HDC hdc, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")]
        public static extern int RemoveFontResource(string lpFileName);
        [DllImport("gdi32")]
        public static extern int ResetDC(HDC hdc, ref DEVMODE lpInitData);
        [DllImport("gdi32")]
        public static extern int ResizePalette(HANDLE hPalette, int nNumEntries);
        [DllImport("gdi32")]
        public static extern int RestoreDC(HDC hdc, int nSavedDC);
        [DllImport("gdi32")]
        public static extern int RoundRect(HDC hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3);
        [DllImport("gdi32")]
        public static extern int SaveDC(HDC hdc);
        [DllImport("gdi32")]
        public static extern int ScaleViewportExtEx(HDC hdc, int nXnum, int nXdenom, int nYnum, int nYdenom, ref SIZE lpSize);
        [DllImport("gdi32")]
        public static extern int ScaleWindowExtEx(HDC hdc, int nXnum, int nXdenom, int nYnum, int nYdenom, ref SIZE lpSize);
        [DllImport("gdi32")]
        public static extern int SelectClipPath(HDC hdc, int iMode);
        [DllImport("gdi32")]
        public static extern int SelectClipRgn(HDC hdc, HANDLE hRgn);
        [DllImport("gdi32")]
        public static extern int SelectObject(HDC hdc, HANDLE hObject);
        [DllImport("gdi32")]
        public static extern int SelectPalette(HDC hdc, HANDLE hPalette, int bForceBackground);
        [DllImport("gdi32")]
        public static extern int SetAbortProc(HWND hdc, ref int lpAbortProc);
        [DllImport("gdi32")]
        public static extern int SetArcDirection(HDC hdc, int ArcDirection);
        [DllImport("gdi32")]
        public static extern int SetBitmapBits(HANDLE hBitmap, int dwCount, IntPtr lpBits);
        [DllImport("gdi32")]
        public static extern int SetBitmapDimensionEx(HANDLE hbm, int nX, int nY, ref SIZE lpSize);
        [DllImport("gdi32")]
        public static extern int SetBkColor(HDC hdc, int crColor);
        [DllImport("gdi32")]
        public static extern int SetBkMode(HDC hdc, int nBkMode);
        [DllImport("gdi32")]
        public static extern int SetBoundsRect(HDC hdc, ref RECT lprcBounds, int flags);
        [DllImport("gdi32")]
        public static extern int SetBrushOrgEx(HDC hdc, int nXOrg, int nYOrg, ref POINT lppt);
        [DllImport("gdi32")]
        public static extern int SetColorAdjustment(HDC hdc, ref COLORADJUSTMENT lpca);
        [DllImport("gdi32")]
        public static extern int SetColorSpace(HDC hdc, HANDLE hcolorspace);
        [DllImport("gdi32")]
        public static extern int SetDIBColorTable(HWND hdc, int un1, int un2, ref RGBQUAD pcRGBQuad);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int SetDeviceGammaRamp(HDC hdc, IntPtr lpv);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int SetICMMode(HDC hdc, int n);
        [DllImport("gdi32")]
        public static extern int SetICMProfile(HDC hdc, string lpStr);
        [DllImport("gdi32")]
        public static extern int SetMapMode(HDC hdc, int nMapMode);
        [DllImport("gdi32")]
        public static extern int SetMapperFlags(HDC hdc, int dwFlag);
        [DllImport("gdi32")]
        public static extern int SetMetaFileBitsEx(int nSize, Byte lpData);
        [DllImport("gdi32")]
        public static extern int SetMetaRgn(HDC hdc);
        [DllImport("gdi32")]
        public static extern int SetMiterLimit(HDC hdc, double eNewLimit, double peOldLimit);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int SetPixel(HDC hdc, int x, int y, int crColor);
        [DllImport("gdi32")]
        public static extern int SetPixelFormat(HWND hdc, int n, ref PIXELFORMATDESCRIPTOR pcPixelFormatDescriptor);
        [DllImport("gdi32")]
        public static extern int SetPixelV(HDC hdc, int x, int y, int crColor);
        [DllImport("gdi32")]
        public static extern int SetPolyFillMode(HDC hdc, int nPolyFillMode);
        [DllImport("gdi32")]
        public static extern int SetROP2(HDC hdc, int nDrawMode);
        [DllImport("gdi32")]
        public static extern int SetRectRgn(HANDLE hRgn, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")]
        public static extern int SetStretchBltMode(HDC hdc, int nStretchMode);
        [DllImport("gdi32")]
        public static extern int SetSystemPaletteUse(HDC hdc, int wUsage);
        [DllImport("gdi32")]
        public static extern int SetTextAlign(HDC hdc, int wFlags);
        [DllImport("gdi32")]
        public static extern int SetTextCharacterExtra(HDC hdc, int nCharExtra);
        [DllImport("gdi32")]
        public static extern int SetTextColor(HDC hdc, int crColor);
        [DllImport("gdi32")]
        public static extern int SetTextJustification(HDC hdc, int nBreakExtra, int nBreakCount);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int SetWinMetaFileBits(int cbBuffer, Byte lpbBuffer, HWND hdcRef, ref METAFILEPICT lpmfp);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int StartDoc(HDC hdc, ref DOCINFO lpdi);
        [DllImport("gdi32")]
        public static extern int StartPage(HDC hdc);
        [DllImport("gdi32")]
        public static extern int StretchBlt(HDC hdc, int x, int y, int nWidth, int nHeight, HANDLE hSrcDC, int xSrc, int ySrc, int nSrcWidth, int nSrcHeight, int dwRop);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int StrokeAndFillPath(HDC hdc);
        [DllImport("gdi32")]
        public static extern int StrokePath(HDC hdc);
        [DllImport("gdi32")]
        public static extern int SwapBuffers(HWND hdc);
        [DllImport("gdi32")]
        ...
        [DllImport("gdi32")]
        public static extern int UnrealizeObject(HANDLE hObject);
        [DllImport("gdi32")]
        public static extern int UpdateColors(HDC hdc);
        [DllImport("gdi32")]
        public static extern int WidenPath(HDC hdc);
