...
namespace MMI.Facility.WPFInfrastructure.View
{
    ...
    public partial class CaretTextBox
    {
        ...
        public static readonly DependencyProperty TextHorizontalAlignmentProperty = DependencyProperty.Register(
            "TextHorizontalAlignment", typeof(HorizontalAlignment), typeof(CaretTextBox), new PropertyMetadata(default(HorizontalAlignment)));
        ...
        public static readonly DependencyProperty TextVerticalAlignmentProperty = DependencyProperty.Register(
            "TextVerticalAlignment", typeof(VerticalAlignment), typeof(CaretTextBox), new PropertyMetadata(default(VerticalAlignment)));
        ...
        private void CaretTextModelOnPropertyChanged(object sender, PropertyChangedEventArgs args)
        {
            ...
            if (args.PropertyName ==
                PropertySupport.ExtractPropertyName<ICaretTextModel, int>(c => c.BindableCaretIndex))
            {
                MoveCustomCaret();
            }
