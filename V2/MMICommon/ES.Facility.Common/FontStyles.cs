...
namespace ES.Facility.Common
{
    ...
    public class FontStyles
    {
        ...
        /// 宋体-12号-垂直居中-水平居中-黑色
        /// </summary>
        public static FontStyle_ES FS_Song_12_CC_B = new FontStyle_ES()
        {
            Font = new Font("宋体", 12),
        ...
        /// 宋体-14号-垂直居中-水平居中-黑色
        /// </summary>
        public static FontStyle_ES FS_Song_14_CC_B = new FontStyle_ES()
        {
            Font = new Font("宋体", 14),
            StringFormat = new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center },
            TextBrush = new SolidBrush(Color.Black)
        ...
        /// 宋体-10号-垂直居中-水平居中-蓝色
        /// </summary>
        public static FontStyle_ES FS_Song_10_CC_Blue = new FontStyle_ES()
        {
        ...
        /// 宋体-14号-垂直居中-水平居中-白色
        /// </summary>
        public static FontStyle_ES FS_Song_14_CC_W = new FontStyle_ES()
        {
        ...
        /// 宋体-20号-垂直居中-水平居中-黑色
        /// </summary>
        public static FontStyle_ES FS_Song_20_CC_B = new FontStyle_ES()
        {
        ...
        /// 宋体-16号-垂直居中-水平居中-黑色
        /// </summary>
        public static FontStyle_ES FS_Song_16_CC_B = new FontStyle_ES()
        {
        ...
        /// 宋体-16号-垂直居中-水平居中-白色
        /// </summary>
        public static FontStyle_ES FS_Song_16_CC_White = new FontStyle_ES()
        {
            Font = new Font("宋体", 16f),
            StringFormat = new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center },
            TextBrush = new SolidBrush(Color.White)
        ...
        /// 宋体-14号-垂直居中-水平居中-白色
        /// </summary>
        public static FontStyle_ES FS_Song_14_CC_WAndB = new FontStyle_ES()
        {
            Font = new Font("宋体", 14f),
            StringFormat = new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center },
            TextBrush = new SolidBrush(Color.White),
        ...
        /// 宋体-20号-垂直居中-水平居中-白色
        /// </summary>
        public static FontStyle_ES FS_Song_20_CC_WAndB = new FontStyle_ES()
        {
            Font = new Font("宋体", 20f),
            StringFormat = new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center },
            TextBrush = new SolidBrush(Color.White),
        ...
        /// 宋体-13号-垂直居中-水平居中-白色
        /// </summary>
        public static FontStyle_ES FS_Song_13_CC_WAndB = new FontStyle_ES()
        {
