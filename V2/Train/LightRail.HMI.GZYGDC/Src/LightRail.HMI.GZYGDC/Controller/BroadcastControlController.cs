...
{
    [Export]
    public class BroadcastControlController : ControllerBase<Lazy<BroadcastControlViewModel>>
    {
       

       
        [ImportingConstructor]
        public BroadcastControlController(Lazy<BroadcastControlViewModel> viewModel) : base(viewModel)
        {
