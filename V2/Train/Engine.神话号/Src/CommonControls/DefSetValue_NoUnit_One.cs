...
{
    public partial class DefSetValue_NoUnit_One : PictureBox, ISetValue
    {
        ...
        public Int32 GetValue()
        {
            ...
            //else if (_defLabels_CurValue[i].DefText != "") value = Convert.ToInt32(strValue);
            return value;
        }
    }
}
