...
{
    public partial class DefSetValue_HaveUnit_Three : UserControl, ISetValue
    {
        ...
        public DefSetValue_HaveUnit_Three()
        {
            InitializeComponent();

            _defLabels_SetValue = new List<DefLabel>()
            {
                _defLabel_Set_1,_defLabel_Set_2,_defLabel_Set_3
            };
            _defLabels_CurValue = new List<DefLabel>()
            {
                _defLabel_Cur_1,_defLabel_Cur_2,_defLabel_Cur_3
            };
        }
