...
{
    public partial class SH_V304_TimeSetting : UserControl, IView
    {
        ...
        public SH_V304_TimeSetting()
        {
            InitializeComponent();
        }

        public SH_V304_TimeSetting(Int32 id, ViewManager viewManager, ICommunicationDataService dataService)
        {
            InitializeComponent();
