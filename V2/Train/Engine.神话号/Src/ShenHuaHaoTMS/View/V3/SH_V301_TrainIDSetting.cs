...
{
    public partial class SH_V301_TrainIDSetting : UserControl, IView
    {
        ...
        public SH_V301_TrainIDSetting()
        {
            InitializeComponent();
        }

        public SH_V301_TrainIDSetting(Int32 id, ViewManager viewManager, ICommunicationDataService dataService)
        {
            InitializeComponent();
