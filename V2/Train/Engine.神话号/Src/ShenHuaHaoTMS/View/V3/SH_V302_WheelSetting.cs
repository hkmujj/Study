...
{
    public partial class SH_V302_WheelSetting : UserControl, IView
    {
        ...
        public SH_V302_WheelSetting()
        {
            InitializeComponent();
        }

        public SH_V302_WheelSetting(Int32 id, ViewManager viewManager, ICommunicationDataService dataService)
        {
            InitializeComponent();
