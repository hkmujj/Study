...
{
    public partial class SH_V4013_FaultLight : UserControl, IView,IDisposable, IDataListener
    {
        ...
        public SH_V4013_FaultLight()
        {
            InitializeComponent();
        }

        public SH_V4013_FaultLight(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, SubsystemInitParam initParam)
        {
            InitializeComponent();
