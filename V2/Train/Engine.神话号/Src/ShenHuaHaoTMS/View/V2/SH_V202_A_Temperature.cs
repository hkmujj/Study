...
{
    public partial class SH_V202_A_Temperature : UserControl, IView,IDisposable, IDataListener
    {
        ...
        public SH_V202_A_Temperature()
        {
            InitializeComponent();
        }

        public SH_V202_A_Temperature(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, BlackView bv, SubsystemInitParam initParam)
        {
            InitializeComponent();
