...
{
    public partial class SH_V204_A_AuxiliarySys : UserControl, IView,IDisposable, IDataListener
    {
        ...
        public SH_V204_A_AuxiliarySys()
        {
            InitializeComponent();
        }

        public SH_V204_A_AuxiliarySys(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, BlackView bv, SubsystemInitParam initParam)
        {
            InitializeComponent();
            ...
            _statesControls = new List<ILogic>()
            {
                ...
                _defState_34_Q10,_defState_34_Q11,_defState_34_Q12,_defState_34_Q13,_defState_34_Q15,_defState_34_Q21,_defState_62_Q01,_defState_32_Q01,
                _defState_34_Q01,_defState_34_Q02,_defState_34_Q03,_defState_34_Q04,_defState_34_Q06,_defState_34_Q05,_defState_34_Q20,_defState_77_Q01,
        ...
        {
            foreach (var cmd in dataChangedArgs.NewValue.ToList())
            {
