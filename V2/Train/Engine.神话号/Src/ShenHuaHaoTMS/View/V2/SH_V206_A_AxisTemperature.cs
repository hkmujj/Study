...
{
    public partial class SH_V206_A_AxisTemperature : UserControl, IView,IDisposable, IDataListener
    {
        ...
        public SH_V206_A_AxisTemperature()
        {
            InitializeComponent();
        }

        public SH_V206_A_AxisTemperature(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, BlackView bv, SubsystemInitParam initParam)
        {
            InitializeComponent();
