...
{
    public partial class SH_V6_ParamConfig_C1 : UserControl,IDisposable, IDataListener
    {

        private List<ILogic> _statesControls = new List<ILogic>();

        public SH_V6_ParamConfig_C1()
        {
            InitializeComponent();
        }

        public SH_V6_ParamConfig_C1(ICommunicationDataService dataService, SubsystemInitParam initParam)
        {
            InitializeComponent();
            Dock = DockStyle.Fill;
            ...
            _statesControls = new List<ILogic>()
            {
                ...
                _defState_28,_defState_29,defState1,defState2
            };
