...
{
    public partial class SH_V503_A_TractionState : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V503_A_TractionState()
        {
            InitializeComponent();
        }

        public SH_V503_A_TractionState(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["A车-牵引封锁"].Rows;
