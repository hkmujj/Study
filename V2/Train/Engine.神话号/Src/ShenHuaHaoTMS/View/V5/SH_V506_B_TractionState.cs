...
{
    public partial class SH_V506_B_TractionState : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V506_B_TractionState()
        {
            InitializeComponent();
        }

        public SH_V506_B_TractionState(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["B车-牵引封锁"].Rows;
