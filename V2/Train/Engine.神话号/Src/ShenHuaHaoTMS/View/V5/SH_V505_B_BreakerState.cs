...
{
    public partial class SH_V505_B_BreakerState : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V505_B_BreakerState()
        {
            InitializeComponent();
        }

        public SH_V505_B_BreakerState(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["B车-主断"].Rows;
