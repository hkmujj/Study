...
{
    public partial class SH_V509_A_TractionState_F : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V509_A_TractionState_F()
        {
            InitializeComponent();
        }
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["从车A-牵引封锁"].Rows;
        ...
        public SH_V509_A_TractionState_F(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
