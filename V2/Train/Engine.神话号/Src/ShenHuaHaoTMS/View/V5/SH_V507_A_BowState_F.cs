...
{
    public partial class SH_V507_A_BowState_F : UserControl, IView,IDisposable, IDataListener
    {
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["从车A-受电弓"].Rows;
        ...
        public SH_V507_A_BowState_F(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, BlackView bv, SubsystemInitParam initParam)
        {
            InitializeComponent();
