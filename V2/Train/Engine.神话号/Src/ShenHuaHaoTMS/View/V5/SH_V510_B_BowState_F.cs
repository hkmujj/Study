...
{
    public partial class SH_V510_B_BowState_F : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["从车B-受电弓"].Rows;
        ...
        public SH_V510_B_BowState_F(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
