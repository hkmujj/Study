...
{
    public partial class SH_V508_A_BreakerState_F : UserControl, IView,IDisposable, IDataListener
    {
        ...
        public SH_V508_A_BreakerState_F()
        {
            InitializeComponent();
        }
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["从车A-主断"].Rows;
        ...
        public SH_V508_A_BreakerState_F(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, BlackView bv, SubsystemInitParam initParam)
        {
            InitializeComponent();
