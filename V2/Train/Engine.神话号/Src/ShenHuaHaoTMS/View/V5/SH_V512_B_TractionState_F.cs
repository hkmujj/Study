...
{
    public partial class SH_V512_B_TractionState_F : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V512_B_TractionState_F()
        {
            InitializeComponent();
        }
        ...
        public void SetData(DataSet ds)
        {
            ...
            DataRowCollection drc = ds.Tables["从车B-牵引封锁"].Rows;
        ...
        public SH_V512_B_TractionState_F(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
