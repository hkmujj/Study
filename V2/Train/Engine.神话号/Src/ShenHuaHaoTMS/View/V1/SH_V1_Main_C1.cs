...
{
    public partial class SH_V1_Main_C1 : UserControl, IDataListener
    {
        private List<ILogic> _statesControls = new List<ILogic>();

        public SH_V1_Main_C1()
        {
            InitializeComponent();
        }

        public SH_V1_Main_C1(ICommunicationDataService dataService)
        {
            InitializeComponent();
            Dock = DockStyle.Fill;
