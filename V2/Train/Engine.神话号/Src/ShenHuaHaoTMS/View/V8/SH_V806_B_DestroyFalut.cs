...
{
    public partial class SH_V806_B_DestroyFalut : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V806_B_DestroyFalut()
        {
            InitializeComponent();
        }

        public SH_V806_B_DestroyFalut(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
