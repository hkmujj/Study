...
{
    public partial class SH_V807_A_OperateInfo_V0 : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public bool IsShow
        {
            ...
            set
            {
                ...
                if (_isShow) //显示
                {
                    ...
                    {
                        ViewManger.Add(this);
                        this.defFalutOperate.SetFalut(_v801.GetCurrentFalut(), ShowState.V0);
                        this.InvokeShow();
                        ;
        ...
        public SH_V807_A_OperateInfo_V0()
        {
            InitializeComponent();
        }

        public SH_V807_A_OperateInfo_V0(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
