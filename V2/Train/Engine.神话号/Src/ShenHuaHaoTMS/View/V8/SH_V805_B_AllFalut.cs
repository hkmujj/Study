...
{
    public partial class SH_V805_B_AllFalut : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V805_B_AllFalut()
        {
            InitializeComponent();
        }

        public SH_V805_B_AllFalut(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, BlackView bv,
            SubsystemInitParam initParam)
        {
            ...
            _bv = bv;
            _bv.FalutChangedB += _bv_FalutChangedA;
