...
{
    public partial class SH_V808_A_OperateInfo_V1 : UserControl, IView,IDisposable, IDataListener
    {
        ...
        private readonly ListenViewChangedBridge m_ListenViewChanged = new ListenViewChangedBridge();public bool IsShow
        {
            ...
            set
            {
                ...
                if (_isShow) //显示
                {
                    ...
                    {
                        ViewManger.Add(this);
                        this.defFalutOperate.SetFalut(_v801.GetCurrentFalut(), ShowState.V1);
                        this.InvokeShow();;
        ...
        public SH_V808_A_OperateInfo_V1()
        {
            InitializeComponent();
        }

        public SH_V808_A_OperateInfo_V1(Int32 id, ViewManager viewManager, ICommunicationDataService dataService, SH_V801_A_CurrentFalut v801, BlackView bv, SubsystemInitParam initParam)
        {
            InitializeComponent();
