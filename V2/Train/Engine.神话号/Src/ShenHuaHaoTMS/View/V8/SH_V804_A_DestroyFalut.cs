...
{
    public partial class SH_V804_A_DestroyFalut : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V804_A_DestroyFalut()
        {
            InitializeComponent();
        }

        public SH_V804_A_DestroyFalut(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
