...
{
    public partial class SH_V809_A_OperateInfo_Info : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public bool IsShow
        {
            ...
            set
            {
                ...
                if (_isShow) //显示
                {
                    ...
                    {
                        ViewManger.Add(this);
                        this.defFalutOperate.SetFalut(_v801.GetCurrentFalut(), ShowState.Info);
                        this.InvokeShow();
                        ;
        ...
        private SH_V801_A_CurrentFalut _v801 = null;

        public SH_V809_A_OperateInfo_Info()
        {
            InitializeComponent();
        }

        public SH_V809_A_OperateInfo_Info(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
            SH_V801_A_CurrentFalut v801, BlackView bv, SubsystemInitParam initParam)
        {
            InitializeComponent();
