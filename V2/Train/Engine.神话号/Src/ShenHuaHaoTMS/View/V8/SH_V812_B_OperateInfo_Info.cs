...
{
    public partial class SH_V812_B_OperateInfo_Info : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public bool IsShow
        {
            ...
            set
            {
                ...
                if (_isShow) //显示
                {
                    ...
                    {
                        ViewManger.Add(this);
                        this.defFalutOperate.SetFalut(_v802.GetCurrentFalut(), ShowState.Info);
                        this.InvokeShow();
                        ;
        ...
        public SH_V812_B_OperateInfo_Info()
        {
            InitializeComponent();
        }

        public SH_V812_B_OperateInfo_Info(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
