...
{
    public partial class SH_V801_A_CurrentFalut : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V801_A_CurrentFalut()
        {
            InitializeComponent();
        }

        public SH_V801_A_CurrentFalut(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
