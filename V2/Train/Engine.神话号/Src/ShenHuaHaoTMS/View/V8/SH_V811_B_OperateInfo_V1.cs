...
{
    public partial class SH_V811_B_OperateInfo_V1 : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public bool IsShow
        {
            ...
            set
            {
                ...
                if (_isShow) //显示
                {
                    ...
                    {
                        ViewManger.Add(this);
                        this.defFalutOperate.SetFalut(_v802.GetCurrentFalut(), ShowState.V1);
                        this.InvokeShow();
                        ;
        ...
        public SH_V811_B_OperateInfo_V1()
        {
            InitializeComponent();
        }

        public SH_V811_B_OperateInfo_V1(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
