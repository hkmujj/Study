...
{
    public partial class SH_V802_B_CurrentFalut : UserControl, IView, IDisposable, IDataListener
    {
        ...
        public SH_V802_B_CurrentFalut()
        {
            InitializeComponent();
        }

        public SH_V802_B_CurrentFalut(Int32 id, ViewManager viewManager, ICommunicationDataService dataService,
        ...
        void _bv_FalutChangedB(FalutState fs)
        {
            ...
            {
                defFalut1.RemoveFalut(fs.CurrentFalut);
            }
        }
