  ...
  a =>
  {
      using (FileStream fs = new FileStream(Path.Combine(RecPath, a), FileMode.Open))
      {
        ...
        public override void paint(Graphics g)
        {
            ...
            //    int a = line[i].IndexOf("[");
            //    string num = line[i].Substring(0, a);
            //    if (BoolList[Convert.ToInt32(num)])
            //    {
            //        append_postCmd(CmdType.ChangePage, 118, 0, 0);
            //    }
            //}
            ...
            g.DrawString("数据监测权限认证", Global.Font_Arial_11_B, Global.brush1, new Rectangle(300, 120, 150, 30), Global.SF_CC);
