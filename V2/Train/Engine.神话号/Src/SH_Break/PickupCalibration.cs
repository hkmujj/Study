...
namespace NJ_MMI
{
    ...
    class PickupCalibration:baseClass 
    {
        /// <summary>
        /// 设置按钮
        /// </summary>
  ...
  a =>
  {
      using (FileStream fs = new FileStream(Path.Combine(RecPath, a), FileMode.Open))
      {
        ...
        public override void paint(Graphics g)
        {
            ...
            g.DrawString("传感器校准权限认证", Global.Font_Arial_11_B, Global.brush1, new Rectangle(300, 120, 180, 30), Global.SF_CC);
            g.DrawString("密码", Global.Font_Arial_11_B, Global.brush1, new Rectangle(300, 170, 40, 30), Global.SF_CC);
            base.paint(g);
        }
    }
}
