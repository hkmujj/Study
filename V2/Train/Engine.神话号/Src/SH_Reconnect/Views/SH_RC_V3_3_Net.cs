...
{
    public partial class SH_RC_V3_3_Net : UserControl, IView,IDataChangedListener
    {
        public SH_RC_V3_3_Net()
        {
            InitializeComponent();
        }
        ...
        public SH_RC_V3_3_Net(Int32 id, ViewManager viewManager, ICommunicationDataService dataService)
        {
            InitializeComponent();
