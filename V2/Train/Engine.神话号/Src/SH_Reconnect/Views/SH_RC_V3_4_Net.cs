...
{
    public partial class SH_RC_V3_4_Net : UserControl, IView,IDataChangedListener
    {
        public SH_RC_V3_4_Net()
        {
            InitializeComponent();
        }
        ...
        public SH_RC_V3_4_Net(Int32 id, ViewManager viewManager, ICommunicationDataService dataService)
        {
            InitializeComponent();
