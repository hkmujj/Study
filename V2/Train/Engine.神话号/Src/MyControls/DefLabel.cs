...
namespace CommonControls
{
    ...
    [Serializable]
    public partial class DefLabel : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_obliqueLine) { e.Graphics.DrawLine(whitePen, new Point(0, 0), new Point(Size.Width - 1, Size.Height - 1)); }
