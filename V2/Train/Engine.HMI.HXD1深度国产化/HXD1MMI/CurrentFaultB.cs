...
namespace HXD1.DeepDomestic
{
    ...
    class CurrentFaultB : baseClass
    {
        ...
        private CurrentFaultTitleRect _currentFaultTitleRect = new CurrentFaultTitleRect(new Rectangle(10, 40, 760, 30), "类别", "车号", "代码", "故障内容", "故障发生时间");
