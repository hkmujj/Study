...
namespace Subway.XiaMenLine1.Interface
{
    public class IndexConfigure
    {
        ...
        const string InBoolConfigFile = "厦门地铁1号线接口_InBool.xls";
        const string InFloatConfigFile = "厦门地铁1号线接口_InFloat.xls";
        const string OutBoolConfigFile = "厦门地铁1号线接口_OutBool.xls";
        const string OutFloatConfigFile = "厦门地铁1号线接口_OutFloat.xls";
