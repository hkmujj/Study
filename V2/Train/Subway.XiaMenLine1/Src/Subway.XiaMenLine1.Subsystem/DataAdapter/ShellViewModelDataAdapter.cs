...
namespace Subway.XiaMenLine1.Subsystem.DataAdapter
{
    [Export]
    public class ShellViewModelDataAdapter : IUpdateStatusProvider, IDisposable, IDataListener
    {
        ...
        private void UpdatePantographStates(CommunicationDataChangedArgs e)
        {
            ...
            args.UpdateIfContains(InBoolKeys.Inb车2号受电弓升弓故障, () => { model.Car2Pantograph = FrsmHighSpeed.PantographUpFault; });
            args.UpdateIfContains(InBoolKeys.Inb车2号受电弓降弓故障, () => { model.Car2Pantograph = FrsmHighSpeed.PantographDownFault; });
            ...
            args.UpdateIfContains(InBoolKeys.Inb车5号受电弓升弓故障, () => { model.Car5Pantograph = FrsmHighSpeed.PantographUpFault; });
            args.UpdateIfContains(InBoolKeys.Inb车5号受电弓降弓故障, () => { model.Car5Pantograph = FrsmHighSpeed.PantographDownFault; });
        ...
        private void UpdateTractionLockState(CommunicationDataChangedArgs e)
        {
            ...
            foreach (var unit in ShellViewModel.Model.EmergencyCause.EnmergencyCause)
            {
                e.ChangedBools.UpdateIfContains(unit.LogicName, b => unit.IsEmergency = b);
            }
        }
