...
namespace Subway.XiaMenLine1.Subsystem.Model
{
    public class AirConditionModel : NotificationObject, IAirCondition
    {
        ...
        private double m_BackFanCar6Num2;
        private double m_BackFanCar6Num1;
        private double m_BackFanCar5Num2;
        private double m_BackFanCar5Num1;
        private double m_BackFanCar4Num2;
        private double m_BackFanCar4Num1;
        private double m_BackFanCar3Num2;
        private double m_BackFanCar3Num1;
        private double m_BackFanCar2Num2;
        private double m_BackFanCar2Num1;
        private double m_BackFanCar1Num2;
        private double m_BackFanCar1Num1;
        ...
        public double BackFanCar1Num1
        {
            get { return m_BackFanCar1Num1; }
            set
            {
                if (value.Equals(m_BackFanCar1Num1))
                {
                    return;
                }
                m_BackFanCar1Num1 = value;
                RaisePropertyChanged(() => BackFanCar1Num1);
            }
        }

        public double BackFanCar1Num2
        {
            get { return m_BackFanCar1Num2; }
            set
            {
                if (value.Equals(m_BackFanCar1Num2))
                {
                    return;
                }
                m_BackFanCar1Num2 = value;
                RaisePropertyChanged(() => BackFanCar1Num2);
            }
        }

        public double BackFanCar2Num1
        {
            get { return m_BackFanCar2Num1; }
            set
            {
                if (value.Equals(m_BackFanCar2Num1))
                {
                    return;
                }
                m_BackFanCar2Num1 = value;
                RaisePropertyChanged(() => BackFanCar2Num1);
            }
        }

        public double BackFanCar2Num2
        {
            get { return m_BackFanCar2Num2; }
            set
            {
                if (value.Equals(m_BackFanCar2Num2))
                {
                    return;
                }
                m_BackFanCar2Num2 = value;
                RaisePropertyChanged(() => BackFanCar2Num2);
            }
        }

        public double BackFanCar3Num1
        {
            get { return m_BackFanCar3Num1; }
            set
            {
                if (value.Equals(m_BackFanCar3Num1))
                {
                    return;
                }
                m_BackFanCar3Num1 = value;
                RaisePropertyChanged(() => BackFanCar3Num1);
            }
        }

        public double BackFanCar3Num2
        {
            get { return m_BackFanCar3Num2; }
            set
            {
                if (value.Equals(m_BackFanCar3Num2))
                {
                    return;
                }
                m_BackFanCar3Num2 = value;
                RaisePropertyChanged(() => BackFanCar3Num2);
            }
        }

        public double BackFanCar4Num1
        {
            get { return m_BackFanCar4Num1; }
            set
            {
                if (value.Equals(m_BackFanCar4Num1))
                {
                    return;
                }
                m_BackFanCar4Num1 = value;
                RaisePropertyChanged(() => BackFanCar4Num1);
            }
        }

        public double BackFanCar4Num2
        {
            get { return m_BackFanCar4Num2; }
            set
            {
                if (value.Equals(m_BackFanCar4Num2))
                {
                    return;
                }
                m_BackFanCar4Num2 = value;
                RaisePropertyChanged(() => BackFanCar4Num2);
            }
        }

        public double BackFanCar5Num1
        {
            get { return m_BackFanCar5Num1; }
            set
            {
                if (value.Equals(m_BackFanCar5Num1))
                {
                    return;
                }
                m_BackFanCar5Num1 = value;
                RaisePropertyChanged(() => BackFanCar5Num1);
            }
        }

        public double BackFanCar5Num2
        {
            get { return m_BackFanCar5Num2; }
            set
            {
                if (value.Equals(m_BackFanCar5Num2))
                {
                    return;
                }
                m_BackFanCar5Num2 = value;
                RaisePropertyChanged(() => BackFanCar5Num2);
            }
        }

        public double BackFanCar6Num1
        {
            get { return m_BackFanCar6Num1; }
            set
            {
                if (value.Equals(m_BackFanCar6Num1))
                {
                    return;
                }
                m_BackFanCar6Num1 = value;
                RaisePropertyChanged(() => BackFanCar6Num1);
            }
        }

        public double BackFanCar6Num2
        {
            get { return m_BackFanCar6Num2; }
            set
            {
                if (value.Equals(m_BackFanCar6Num2))
                {
                    return;
                }
                m_BackFanCar6Num2 = value;
                RaisePropertyChanged(() => BackFanCar6Num2);
            }
        }
        ...
        {
            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车1回风温度1], f => BackFanCar1Num1 = f);
            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车1回风温度2], f => BackFanCar1Num2 = f);

            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车2回风温度1], f => BackFanCar2Num1 = f);
            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车2回风温度2], f => BackFanCar2Num2 = f);

            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车3回风温度1], f => BackFanCar3Num1 = f);
            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车3回风温度2], f => BackFanCar3Num2 = f);

            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车4回风温度1], f => BackFanCar4Num1 = f);
            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车4回风温度2], f => BackFanCar4Num2 = f);

            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车5回风温度1], f => BackFanCar5Num1 = f);
            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车5回风温度2], f => BackFanCar5Num2 = f);

            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车6回风温度1], f => BackFanCar6Num1 = f);
            args.UpdateIfContains(IndexConfigure.Instance.IndexFacade.InFloatDictionary[InFloatKeys.车6回风温度2], f => BackFanCar6Num2 = f);
