...
namespace Engine.HMI.HXD1C.TPX21A
{
    ...
    class HX_LibraryTrainStatus:baseClass,IButtonEventListener
    {
        ...
        private readonly bool[] m_IsTrue = new bool[21];
        ...
        {
            if (GlobalParam.Instance.CurrentViewId == 12)
            {
        ...
        private void LoadTestInfo()
        {
            ...
            foreach (var cStr in all)
            {
                ...
                if (str.Length == 3 && str[0].Equals("2"))
                {
                    m_InfoList.Add(m_InfoList.Count, str[2]);
                } 
            }
        }
