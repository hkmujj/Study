...
namespace Subway.ShenZhenLine9.ViewModels
{
    ...
    public class HSCBViewModel : ViewModelBase
    {
        ...
        private bool m_AllDoorClose2;
        private bool m_AllDoorClose1;
        ...
        private void NetWorkResponse(DataChangedEventArgs<bool> dataChangedEventArgs)
        {
            ...
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.所有门闭合1, b => AllDoorClose1 = b);
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.所有门闭合2, b => AllDoorClose2 = b);
        }
        ...
        /// 所有门关闭1
        /// </summary>
        public bool AllDoorClose1
        {
            get { return m_AllDoorClose1; }
            set
            {
                if (value == m_AllDoorClose1)
                    return;

                m_AllDoorClose1 = value;
                RaisePropertyChanged(() => AllDoorClose1);
            }
        }
        ...
        /// 所有门关闭2
        /// </summary>
        public bool AllDoorClose2
        {
            get { return m_AllDoorClose2; }
            set
            {
                if (value == m_AllDoorClose2)
                    return;

                m_AllDoorClose2 = value;
                RaisePropertyChanged(() => AllDoorClose2);
            }
        }
    }
}