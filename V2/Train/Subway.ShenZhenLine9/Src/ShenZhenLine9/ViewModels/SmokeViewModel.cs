...
namespace Subway.ShenZhenLine9.ViewModels
{
    ...
    public class SmokeViewModel : ViewModelBase
    {
        ...
        private void NetWorkResponse(DataChangedEventArgs<bool> dataChangedEventArgs)
        {
            ...
            tmp.Add(InBoolKeys.车1超过一定数量的温烟探测器失效, () => Car1SmokeState = SmokeState.OffLine);
            ...
            tmp.Add(InBoolKeys.车2超过一定数量的温烟探测器失效, () => Car2SmokeState = SmokeState.OffLine);
            ...
            tmp.Add(InBoolKeys.车3超过一定数量的温烟探测器失效, () => Car3SmokeState = SmokeState.OffLine);
            ...
            tmp.Add(InBoolKeys.车4超过一定数量的温烟探测器失效, () => Car4SmokeState = SmokeState.OffLine);
            ...
            tmp.Add(InBoolKeys.车5超过一定数量的温烟探测器失效, () => Car5SmokeState = SmokeState.OffLine);
            ...
            tmp.Add(InBoolKeys.车6超过一定数量的温烟探测器失效, () => Car6SmokeState = SmokeState.OffLine);
