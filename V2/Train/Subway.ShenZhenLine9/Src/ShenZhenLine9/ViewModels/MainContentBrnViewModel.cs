...
namespace Subway.ShenZhenLine9.ViewModels
{
    ...
    public class MainContentBrnViewModel : ViewModelBase
    {
        ...
        private bool m_LcuFault;
        private bool m_LeeFeedFault;
        ...
        /// 走行功能区故障
        /// </summary>
        public bool LeeFeedFault
        {
            get { return m_LeeFeedFault; }
            set
            {
                if (value == m_LeeFeedFault)
                {
                    return;
                }
                m_LeeFeedFault = value;
                RaisePropertyChanged(() => LeeFeedFault);
            }
        }
        ...
        /// LCU功能区故障
        /// </summary>
        public bool LCUFault
        {
            get { return m_LcuFault; }
            set
            {
                if (value == m_LcuFault)
                {
