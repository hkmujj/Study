...
namespace Subway.ShenZhenLine9.ViewModels
{
    ...
    /// </summary>
    [Export]
    public class ShenZhenLine9ViewModel : NotificationObject, IDataListener
    {
        ...
        public ShenZhenLine9ViewModel(ShenZhenLine9Controller controller, IEventAggregator eventAggregator)
        {
        ...
        /// 控制类
        /// </summary>
        public ShenZhenLine9Controller Controller { get; }
        /// <summary>
        /// MasterPageViewModel
        /// </summary>
        [Import]
