...
namespace Subway.ShenZhenLine9.ViewModels
{
    ...
    public class TractionLockViewModel : ViewModelBase
    {
        ...
        private bool m_Car2RainRemove;
        private bool m_Car6RainRemove;
        private bool m_Car5RainRemove;
        private bool m_Car4RainRemove;
        private bool m_Car3RainRemove;
        ...
        /// 车辆1列车移动时制动不缓解
        /// </summary>
        public bool Car1RainRemove
        {
            get { return m_Car1RainRemove; }
            set
            {
                if (value == m_Car1RainRemove)
                {
                    return;
                }
                m_Car1RainRemove = value;
                RaisePropertyChanged(() => Car1RainRemove);
            }
        }
        ...
        /// 车辆2列车移动时制动不缓解
        /// </summary>
        public bool Car2RainRemove
        {
            get { return m_Car2RainRemove; }
            set
            {
                if (value == m_Car2RainRemove)
                    return;

                m_Car2RainRemove = value;
                RaisePropertyChanged(() => Car2RainRemove);
            }
        }
        ...
        /// 车辆3列车移动时制动不缓解
        /// </summary>
        public bool Car3RainRemove
        {
            get { return m_Car3RainRemove; }
            set
            {
                if (value == m_Car3RainRemove)
                    return;

                m_Car3RainRemove = value;
                RaisePropertyChanged(() => Car3RainRemove);
            }
        }
        ...
        /// 车辆4列车移动时制动不缓解
        /// </summary>
        public bool Car4RainRemove
        {
            get { return m_Car4RainRemove; }
            set
            {
                if (value == m_Car4RainRemove)
                    return;

                m_Car4RainRemove = value;
                RaisePropertyChanged(() => Car4RainRemove);
            }
        }
        ...
        /// 车辆5列车移动时制动不缓解
        /// </summary>
        public bool Car5RainRemove
        {
            get { return m_Car5RainRemove; }
            set
            {
                if (value == m_Car5RainRemove)
                    return;

                m_Car5RainRemove = value;
                RaisePropertyChanged(() => Car5RainRemove);
            }
        }
        ...
        /// 车辆6列车移动时制动不缓解
        /// </summary>
        public bool Car6RainRemove
        {
            get { return m_Car6RainRemove; }
            set
            {
                if (value == m_Car6RainRemove)
                    return;

                m_Car6RainRemove = value;
                RaisePropertyChanged(() => Car6RainRemove);
            }
        }
    }
}