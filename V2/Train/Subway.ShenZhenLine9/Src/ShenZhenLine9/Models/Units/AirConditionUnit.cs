    ...
    public class AirConditionUnit : NotificationObject, ISetValueProvider, IUnit
    {
        ...
        public void DataChanged(IDictionary<int, bool> args)
        {
            args.UpdateIfContain(Fault, b =>
             {
                 State = m_AirConditionPriorityService.GetPriorityValue(this, AirConditionState.Fault, b);
             });
            args.UpdateIfContain(Run, b =>
            {
                State = m_AirConditionPriorityService.GetPriorityValue(this, AirConditionState.Run, b);
            });
            args.UpdateIfContain(Off, b =>
            {
                State = m_AirConditionPriorityService.GetPriorityValue(this, AirConditionState.Off, b);
            });
            args.UpdateIfContain(Cut, b =>
            {
                State = m_AirConditionPriorityService.GetPriorityValue(this, AirConditionState.Cut, b);
            });
        }
    }
