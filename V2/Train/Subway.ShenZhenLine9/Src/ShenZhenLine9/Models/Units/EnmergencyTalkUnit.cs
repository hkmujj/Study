    ...
    public class EnmergencyTalkUnit : NotificationObject, IUnit, ISetValueProvider
    {
        ...
        public void DataChanged(IDictionary<int, bool> args)
        {
            args.UpdateIfContain(Fault, b =>
             {
                 State = m_EmergencyTalkPriorityService.GetPriorityValue(this,EmergencyTalkState.Fault, b);
             });
            args.UpdateIfContain(Active, b =>
            {
                State = m_EmergencyTalkPriorityService.GetPriorityValue(this, EmergencyTalkState.Active, b);
            });
            args.UpdateIfContain(Talk, b =>
            {
                State = m_EmergencyTalkPriorityService.GetPriorityValue(this, EmergencyTalkState.Talk, b);
            });
            args.UpdateIfContain(UnActive, b =>
            {
                State = m_EmergencyTalkPriorityService.GetPriorityValue(this, EmergencyTalkState.UnActive, b);
            });
        }
