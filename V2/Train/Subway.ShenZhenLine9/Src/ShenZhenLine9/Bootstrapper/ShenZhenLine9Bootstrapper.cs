...
namespace Subway.ShenZhenLine9.Bootstrapper
{
    /// <summary>
    /// 深圳七号线 启动加载器
    /// </summary>
    public class ShenZhenLine9Bootstrapper : MefBootstrapper
    {
        /// <summary>
        ...
        {
            GlobalParam.Instance.Initialize(Path.Combine(AppDomain.CurrentDomain.BaseDirectory,"Config"),Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Subway.ShenZhenLine9.车辆屏", "config"));
