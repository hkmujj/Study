...
namespace Subway.ShenZhenLine9.Controller.ViewModelController
{
    ...
    public class TractionLockController : ControllerBase<TractionLockViewModel>
    {
        ...
        private void NetResponse(DataChangedEventArgs<bool> dataChangedEventArgs)
        {
            ...
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.列车移动时制动不缓解1, b => ViewModel.Car1RainRemove = b);
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.列车移动时制动不缓解2, b => ViewModel.Car2RainRemove = b);
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.列车移动时制动不缓解3, b => ViewModel.Car3RainRemove = b);
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.列车移动时制动不缓解4, b => ViewModel.Car4RainRemove = b);
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.列车移动时制动不缓解5, b => ViewModel.Car5RainRemove = b);
            dataChangedEventArgs.Data.UpdateIfContain(InBoolKeys.列车移动时制动不缓解6, b => ViewModel.Car6RainRemove = b);
        }
    }
}