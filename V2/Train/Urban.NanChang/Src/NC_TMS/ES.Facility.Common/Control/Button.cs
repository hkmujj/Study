...
namespace ES.Facility.Common.Control
{
    ...
    public class Button : IControl, IDisposable
    {
        ...
        public event EventHandle_ClickEvent DownEvent
        {
            add { _downEvent += value; }
            remove { _downEvent -= value; }
        }
        private EventHandle_ClickEvent _downEvent = null;
        #endregion
        ...
        public void MouseDown(Point p)
        {
            ...
            {
                if (_downEvent != null)
                    _downEvent(this, new ClickEventArgs<int>(_id));
        ...
        public void Paint(Graphics dcGs)
        {
            ...
            {
                if (((ButtonStyle)this._style).DisableImage == null)
                    ((ButtonStyle)this._style).DisableImage = Image.FromFile(System.IO.Directory.GetCurrentDirectory() + @"/Resource/Btn_Disable.png");
            ...
            {
                if (((ButtonStyle)this._style).DownImage!=null)
