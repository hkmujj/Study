...
namespace NC_TMS
{
    ...
    public class V703_Check_PasswordSetting_C0 : baseClass
    {
        ...
        void btn_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            switch (e.Message)
            {
                ...
                default://0-9数字按钮
                    ...
                    {
                        TextBox textBox = this._textBoxs.Find(a => a.IsFocus);
                        textBox.Text = "******";
                        textBox.IsFocus = false;
                        if (textBox.ID == 0)
                        {
                            this._textBoxs[1].IsFocus = true;
                            this._newPassword = this._password;
                        }
                        else this._surePassword = this._password;
        ...
        public override void paint(Graphics dcGs)
        {
            ...
            this._textBoxs.ForEach(a => a.Paint(dcGs));
        ...
        public void paint_Password(Graphics dcGs)
        {
            ...
            TextBox textBox = this._textBoxs.Find(a => a.IsFocus);
            if (textBox != null) this._textBoxs.Find(a => a.IsFocus).Text = password;
        }
        #endregion
    }
}
