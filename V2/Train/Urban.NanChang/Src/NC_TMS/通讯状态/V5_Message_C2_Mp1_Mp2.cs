...
namespace NC_TMS
{
    ...
    public class V5_Message_C2_Mp1_Mp2 : baseClass
    {
        #region 私有变量
        ...
        public override bool init(ref int nErrorObjectIndex)
        {
            ...
            string[] strs = File.ReadAllLines(Path.Combine(RecPath, "..\\config\\Mp模块信息.txt"), System.Text.Encoding.Default);
        ...
        /// </summary>
        /// <param name="dcGs"></param>
        private void paint_MpMode(Graphics dcGs)
        {
            float axis1 = 260;
            float axis2 = 545;
