...
namespace NJ_MMI
{
    ...
    public class V2_C1_DriverID : baseClass
    {
        ...
        private List<Int32> driverID = new List<int>();
        ...
        void _btn_OK_MouseUpEvent(int obj)
        {
            ...
            append_postCmd(CmdType.SetFloatValue, this.UIObj.OutFloatList[0], 0, Convert.ToInt32(this._driverID));
        }

        void _btn_Cancel_MouseUpEvent(int obj)
        {
            this._driverID = String.Empty;
        }
