...
namespace Motor.HMI.CRH380D.Controller.BtnActionResponser.HandleTestView
{
    [Export]
    public class ActivateTest : BtnActionResponserBase
    {
        public override void ResponseClick()
        {
            ViewModel.Value.Model.HandleTestModel.HandleTestController.ActivateTest();
        }
    }
