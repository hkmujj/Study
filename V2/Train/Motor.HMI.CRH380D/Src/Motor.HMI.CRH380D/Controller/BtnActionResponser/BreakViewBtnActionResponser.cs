...
namespace Motor.HMI.CRH380D.Controller.BtnActionResponser.BreakView
{
    [Export]
    public class RemoveIceBreak : BtnActionResponserBase
    {
        public override void ResponseClick()
        {
            ViewModel.Value.Model.BreakModel.BreakController.RemoveIceBreakSendData();
        }
    }
