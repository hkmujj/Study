...
namespace Motor.HMI.CRH380D.Service
{
    ...
    /// 门优先级服务
    /// </summary>
    public class GroundingPriorityService : PriorityServiceBase<GroundingState>
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="dooPriorities"></param>
        public GroundingPriorityService(IList<Priority<GroundingState, int>> dooPriorities)
        {
