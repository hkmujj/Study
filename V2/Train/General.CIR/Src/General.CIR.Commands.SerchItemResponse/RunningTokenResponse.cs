...
{
	public class RunningTokenResponse : CustomCommandBase
	{
		protected override void CommandAction()
		{
			IEnumerable<DispatchCommandUnit> collection = ViewModel.DispatchCommandViewModel.AllUnit.Where(w=> w.CommandType == CommandType.RoadTicket || w.CommandType == CommandType.OutStation || w.CommandType == CommandType.RedPermit || w.CommandType == CommandType.GreenPermit);
