...
{
    public class RoutePrevueResponse : CustomCommandBase
    {


        protected override void CommandAction()
        {
            IEnumerable<DispatchCommandUnit> collection = ViewModel.DispatchCommandViewModel.AllUnit.Where(w => w.CommandType == CommandType.InRoad);
