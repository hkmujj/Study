...
namespace Motor.HMI.CRH5G.底层共用.RectView
{
    ...
    public class RectState
    {
        ...
        public virtual void ChangeRectState(CRH5GBase obj, bool nParaGreen, bool nParaRed, bool nParaYellow)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual RectangleF GetRectLocal(CRH5GBase activeObj = null)
        {
        ...
        public void DrawRectState(Graphics g, CRH5GBase activeObj = null)
        {
        ...
        public void RefreshStateColor(CRH5GBase baseClass)
        {
        ...
        public virtual bool HasInit(CRH5GBase obj = null)
        {
