...
namespace Motor.HMI.CRH5G.底层共用
{
    public static class Coordinate
    {
        public static List<RectangleF> RectangleFLists(ViewIDName className)
        {
            ...
            switch (className)
            {
                ...
                case ViewIDName.TitleScreen:
                    ...
                    for (i = 0; i < 16; i++)
                    {
                        m_TheRectFListTitleScreen.Add(RectsMovemont(131 + i * 41, 58, 13, 10));
                    }
                    //34-35    /8车*
                    for (i = 0; i < 2; i++)
                    {
             ...
             */
                ...
                case ViewIDName.InstrumentScreen1:
                    ...
                    m_TheRectFListInstrumentScreen1.Add(RectsMovemont(155, 60, 150 , 60));
                    m_TheRectFListInstrumentScreen1.Add(RectsMovemont(133, 75, 200 , 60));
                    m_TheRectFListInstrumentScreen1.Add(RectsMovemont(155, 90, 150, 60));
                ...
                case ViewIDName.InstrumentScreen2:
                    ...
                    m_TheRectFListInstrumentScreen2.Add(RectsMovemont(30, 100, 420, 420));
                    for (i = 0; i < 2; i++)
                    {
                ...
                case ViewIDName.SystemOneSettings:
                    ...
                    //}
                    //边框   /0
                    m_TheRectFListSystemOneSettings.Add(RectsMovemont(50, 100, 700, 400));
                    //提示框  /1
                    m_TheRectFListSystemOneSettings.Add(RectsMovemont(300, 150, 200, 50));
                    //5个密码框  /2-6
                    for (i = 0; i < 5; i++)
                    {
                        m_TheRectFListSystemOneSettings.Add(RectsMovemont(300 + 45 * i, 210, 30, 30));
                    }
                ...
                case ViewIDName.PassWord:
                    //边框   /0
                    m_TheRectFListPassWord.Add(RectsMovemont(50, 100, 700, 400));
                    //提示框  /1
                    m_TheRectFListPassWord.Add(RectsMovemont(300, 150, 200, 50));
                    //5个密码框  /2-6
                    for (i = 0; i < 5; i++)
                    {
                        m_TheRectFListPassWord.Add(RectsMovemont(300 + 45 * i, 210, 30, 30));
                    }
                ...
                #region:::::::::::::::语言时间设置:::::::::::::::::::
                    ...
                    case ViewIDName.LanguageTimeSettings:
                    //底图
                    m_TheRectFListLanguageTimeSettings.Add(RectsMovemont( 0, 0, 800, 600));
                    m_TheRectFListLanguageTimeSettings.Add(RectsMovemont( 110, 230, 170, 45));
                    m_TheRectFListLanguageTimeSettings.Add(RectsMovemont( 110, 280, 170, 45));



                    return m_TheRectFListLanguageTimeSettings;
        ...
        private static List<RectangleF> m_TheRectFListLanguageTimeSettings = new List<RectangleF>();
