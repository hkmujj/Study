...
namespace Subway.ShenZhenLine7.Models.ButtonModel
{
    ...
    public class StateKey : IStateKey
    {
        ...
        /// </summary>
        /// <returns>
        /// 当前 <see cref="T:Subway.ShenZhenLine7.Models.ButtonModel.StateKey"/> 的哈希代码。
        /// </returns>
        ...
        /// <summary>
        /// 返回表示当前 <see cref="T:Subway.ShenZhenLine7.Models.ButtonModel.StateKey"/> 的 <see cref="T:System.String"/>。
        /// </summary>
        /// <returns>
        /// <see cref="T:System.String"/>，表示当前的 <see cref="T:Subway.ShenZhenLine7.Models.ButtonModel.StateKey"/>。
        /// </returns>
