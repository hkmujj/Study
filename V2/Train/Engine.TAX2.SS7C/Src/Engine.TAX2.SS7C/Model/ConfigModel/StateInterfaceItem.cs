...
{
    [ExcelLocation("Engine.TAX2.SS7C按键状态集.xls", "Sheet1")]
    ...
    public class StateInterfaceItem : ISetValueProvider
    {
        ...
        [ExcelField("内容控件位置")]
        public ContentViewLocation ContentViewLocation { private set; get; }
        ...
        public void SetValue(string propertyOrFieldName, string value)
        {
            ...
            {
                case "ContentViewLocation":
                    ContentViewLocation loc;
                    if (Enum.TryParse(value, out loc))
                    {
                        ContentViewLocation = loc;
                    }
                    break;
