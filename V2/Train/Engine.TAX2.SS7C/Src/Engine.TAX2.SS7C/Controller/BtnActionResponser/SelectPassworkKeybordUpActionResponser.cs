...
{
    [Export]
    public class SelectPassworkKeybordUpActionResponser : BtnActionResponserBase
    {
        /// <summary>
        /// 响应按键
        /// </summary>
        public override void ResponseClick()
        {
            ...
            idx = (idx + KeybordStrings.Instance.Numbers.Count - KeybordStrings.CountPerLine)%KeybordStrings.Instance.Numbers.Count;
