...
namespace Engine.Angola.TCMS
{
    public class GDICommonColor
    {
        ...
        /// 绿色
        /// </summary>
        public readonly static System.Windows.Media.Color GreenColor = System.Windows.Media.Color.FromRgb(0, 128, 0);

        public static readonly System.Windows.Media.Color LimeColor = System.Windows.Media.Color.FromRgb(0, 255, 0);

        public readonly static System.Windows.Media.Color IndianRedColor = System.Windows.Media.Color.FromRgb(205,92,92);

        public static readonly System.Windows.Media.Color CyanColor = System.Windows.Media.Color.FromRgb(0, 255, 255);
        ...
        public readonly static SolidColorBrush IndianRedBrush = new SolidColorBrush(IndianRedColor);
        public readonly static SolidColorBrush LimeBrush = new SolidColorBrush(LimeColor);
        public readonly static SolidColorBrush CyanBrush = new SolidColorBrush(CyanColor);
