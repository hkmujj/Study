...
{
    public class DoorFlickerConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return  ((left == DoorState.Unkown || left == DoorState.Closed) && (right == DoorState.Unkown || right == DoorState.Closed)) && allowState != DoorAllowState.Unkown
