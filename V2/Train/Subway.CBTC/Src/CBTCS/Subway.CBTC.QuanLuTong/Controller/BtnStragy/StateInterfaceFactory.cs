...
namespace Subway.CBTC.QuanLuTong.Controller.BtnStragy
{
    ...
    public class StateInterfaceFactory : IStateInterfaceFactory
    {
        ...
        private void CreateStateInterface(StateInterfaceKey interfaceKey)
        {
            ...
            if (itConfig != null)
            {
                var state = new StateInterface
                {
                    ...
                    ContentViewName = string.Format("Subway.CBTC.QuanLuTong.View.Contents.{0}", itConfig.ContentViewName),
        ...
        {
            var actionClassFullName = string.Format("Subway.CBTC.QuanLuTong.Controller.BtnActionResponser.{0}",
                actionClassName);
