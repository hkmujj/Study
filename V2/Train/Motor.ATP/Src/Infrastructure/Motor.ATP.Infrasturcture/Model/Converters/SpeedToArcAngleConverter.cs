...
{
    public class SpeedToArcAngleConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return (double)((ISpeedDialPlate)values[0]).ConvertSpeedToDrawArcAngle(System.Convert.ToSingle(values[1]));
