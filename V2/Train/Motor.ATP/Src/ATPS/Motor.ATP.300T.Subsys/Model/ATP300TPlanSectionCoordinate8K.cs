...
{
    public class ATP300TPlanSectionCoordinate8K : PlanSectionCoordinateBase
    {
        public ATP300TPlanSectionCoordinate8K()
        {
            CanZoomIn = false;
            CanZoomOut = true;
            ...
            {
                new LineValueLogarithmScalConverter(0, 500, 10, 0, rap0),
                new LineValueLineScaleConverter(500, 1000, rap0, ranp),
                new LineValueLineScaleConverter(1000, 2000, rap0 + ranp, ranp),
                new LineValueLineScaleConverter(2000, 4000, rap0 + ranp*2, ranp),
