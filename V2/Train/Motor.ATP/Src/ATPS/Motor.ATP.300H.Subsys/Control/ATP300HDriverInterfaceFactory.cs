...
using Motor.ATP._300H.Subsys.Control.UserAction.ActionResponser;
using Motor.ATP._300H.Subsys.Control.UserAction.StateProvider;

namespace Motor.ATP._300H.Subsys.Control
{
    public class ATP300HDriverInterfaceFactory : DriverInterfaceFactory
    {
        public ATP300HDriverInterfaceFactory(IATP atp)
            : base(atp)
        {
            ...
            m_ConfigFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config\\ATP300H F 区结构定义.xls");
