...
{
    public class F2CTCS0StateProvider : DriverSelectableItemStateProviderBase
    {
        ...
        public override void Initalize(IDriverSelectableItem item)
        {
            base.Initalize(item);
            UpdateEnable();
            ATP.RegionFStateProvier.CTCS0StateProvider.PropertyChanged += ShuntingStateProviderOnPropertyChanged;
        }
        ...
        {
            Enabled = ATP.RegionFStateProvier.CTCS0StateProvider.Enabled;
        }
