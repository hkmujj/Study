using System.Linq;
using System.Text;
using Motor.ATP._200C.Subsys.WPFView.PopupViews.Contents;
...
namespace Motor.ATP._200C.Subsys.Constant
{
    public class PopupContentViewNames
    {
        ...
        public static readonly string CheckSoftwareVersionInfoView = typeof(CheckSoftwareVersionInfoView).FullName;
        ...
        private static void GetNames()
        {
            ...
            foreach (var t in tps.Where(w => w.FullName.Contains("Motor.ATP._200C.Subsys.WPFView.PopupViews.Contents")))
            {
