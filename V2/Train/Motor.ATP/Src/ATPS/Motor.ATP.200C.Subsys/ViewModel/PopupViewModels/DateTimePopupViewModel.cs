...
namespace Motor.ATP._200C.Subsys.ViewModel.PopupViewModels
{
    ...
    public class DateTimePopupViewModel : DriverPopupViewModelBase
    {
        ...
        public DateTimePopupViewModel()
        {
            ...
            m_ControlWordInterpreter = new DataInputControlWordInterpreter(UserActionType.F7, UserActionType.None);

            PopupViewName = PopupContentViewNames.InputDateTimeView;
            TitleContent = PopupViewStringKeys.StringDateTimeInputting;
            PopViewTitleContent = PopupViewStringKeys.StringDateTime;
        }
