using System.Linq;
using System.Text;
using Motor.ATP._300S.Subsys.WPFView.PopupViews.Contents;

namespace Motor.ATP._300S.Subsys.Constant
{
    public class PopupContentViewNames
    {
        ...
        private static void GetNames()
        {
            ...
            foreach (var t in tps.Where(w => w.FullName.Contains("Motor.ATP._300S.Subsys.WPFView.PopupViews.Contents")))
            {
