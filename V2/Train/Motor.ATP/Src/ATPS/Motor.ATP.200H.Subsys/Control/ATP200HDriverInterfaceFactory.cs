...
using Motor.ATP._200H.Subsys.Control.UserAction.ActionResponser;
using Motor.ATP._200H.Subsys.Control.UserAction.StateProvider;

namespace Motor.ATP._200H.Subsys.Control
{
    public class ATP200HDriverInterfaceFactory : DriverInterfaceFactory
    {
        public ATP200HDriverInterfaceFactory(IATP atp)
            : base(atp)
        {
            ...
            m_ConfigFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config\\ATP200H F 区结构定义.xls");
