...
namespace Motor.ATP._200H.Subsys.Model.Message
{
    public class ATP200HMessage : Infrasturcture.Model.Message.Message
    {
        private IMessageItem m_CurrentFlickingMessageItem;

        public ATP200HMessage(ATPDomain atp) : base(atp)
        {
