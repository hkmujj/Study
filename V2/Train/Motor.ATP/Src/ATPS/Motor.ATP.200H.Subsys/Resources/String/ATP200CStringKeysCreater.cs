...
namespace Motor.ATP._200H.Subsys.Resources.String
{
    internal sealed class ATP200HStringKeysCreater
    {
        ...
        private static void Create()
        {
            var path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory,
                @"..\Src\ATPS\Motor.ATP.200H.Subsys\Resources\String");

            var sb = new StringBuilder();

            sb.AppendFormat(
                "namespace {0}\r\n{{\r\n    /// <summary>\r\n    /// 200H String 键值\r\n    /// </summary>\r\n    " +
                "public static class ATP200HStringKeys{{",
                typeof(ATP200HStringKeysCreater).Namespace);
            ...
            var tar = Path.Combine(path, "ATP200HStringKeys.cs");
        ...
        private static void OrderKeys()
        {
            ...
            )
            {
                ...
                var preLen = "Motor.ATP.200H.String.".Length;
                foreach (string k in rd.Keys.OfType<string>().OrderBy(o => o))
                {
