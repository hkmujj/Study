...
namespace HD_HXD2_TMS.VC公共组件
{
    ...
    public class HD_VC_CurrentFalutA : baseClass
    {
        ...
        {
            if (HD_VC_FalutManager.IsShowCurrentAView)
            {
                _btns[0].IsReplication = false;
                _btns[1].IsReplication = true;
                HD_VC_FalutManager.IsShowCurrentAView = false;
                HD_VC_FalutManager.IsShowCurrentBView = true;
            }
        }
        ...
        void btnPage_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            switch (e.Message)
            {
                ...
                case 1://上一页
                    ...
                    break;
                case 2://下一页
                    if (_currentPage < HD_VC_FalutManager.FalutsACurrent.Count / 16) _currentPage++;
                    break;
            }
        }
        ...
        {
            if (HD_VC_FalutManager.FalutsACurrent == null || HD_VC_FalutManager.FalutsACurrent.Count == 0)
                return;

            //获取到当前页故障
            List<FalutInfo> histroyFaluts = HD_VC_FalutManager.FalutsACurrent;
