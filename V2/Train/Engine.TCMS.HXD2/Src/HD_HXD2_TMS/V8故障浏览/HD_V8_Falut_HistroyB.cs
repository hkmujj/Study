...
namespace HD_HXD2_TMS.V8故障浏览
{
    ...
    public class HD_V8_Falut_HistroyB : baseClass
    {
        ...
        void btnTrain_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            ...
            append_postCmd(CmdType.ChangePage, (Int32)ViewType.FalutHistroyA, 0, 0);
        }
        ...
        void btnPage_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            switch(e.Message)
            {
                ...
                case 1://上一页
                    ...
                    break;
                case 2://下一页
                    if (_currentPage < HD_VC_FalutManager.FalutsBHistroy.Count / 16) _currentPage++;
                    break;
            }
        }
        ...
        void btn_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            ...
            append_postCmd(CmdType.ChangePage, (Int32)ViewType.FalutConveterB, 0, 0);//跳转到主断查询界面
        }
        ...
        {
            if (HD_VC_FalutManager.FalutsBHistroy == null || HD_VC_FalutManager.FalutsBHistroy.Count == 0)
                return;

            //获取到当前页故障
            List<FalutInfo> histroyFaluts = HD_VC_FalutManager.FalutsBHistroy;
