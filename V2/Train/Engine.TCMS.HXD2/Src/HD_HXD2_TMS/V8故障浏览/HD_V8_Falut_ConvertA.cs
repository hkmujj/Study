...
namespace HD_HXD2_TMS.V8故障浏览
{
    ...
    public class HD_V8_Falut_ConvertA : baseClass
    {
        ...
        void btnTrain_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            ...
            append_postCmd(CmdType.ChangePage, (Int32)ViewType.FalutConveterB, 0, 0);
        }
        ...
        void btn_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            ...
            append_postCmd(CmdType.ChangePage, (Int32)ViewType.FalutHistroyA, 0, 0);//跳转到主断查询界面
        }
        ...
        {
            if (HD_VC_ConverterManager.FalutsAHistroy == null || HD_VC_ConverterManager.FalutsAHistroy.Count == 0)
                return;

            //获取到当前页故障
            List<FalutInfo> histroyFaluts = HD_VC_ConverterManager.FalutsAHistroy;
