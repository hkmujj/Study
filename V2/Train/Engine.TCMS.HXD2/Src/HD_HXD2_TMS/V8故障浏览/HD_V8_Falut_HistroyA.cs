...
namespace HD_HXD2_TMS.V8故障浏览
{
    ...
    public class HD_V8_Falut_HistroyA : baseClass
    {
        ...
        public override bool init(ref int nErrorObjectIndex)
        {
            ...
            _rect = new List<Rectangle>()
            {
                ...
                new Rectangle(226,144,286,43),
                new Rectangle(511,144,43,43),
                new Rectangle(553,144,48,43),
                new Rectangle(600,144,48,43),
                new Rectangle(647,144,48,43),
                new Rectangle(694,144,39,43),
                new Rectangle(732,144,54,43)
            };
            ...
            ((ButtonStyle)_btns[0].Style).FontStyle.TextBrush = (SolidBrush)Brushes.Black;
            ...
            _btnsTrain[0].IsReplication = false;
        ...
        {
            _btnsTrain[0].IsReplication = false;
            _btnsTrain[1].IsReplication = true;
            append_postCmd(CmdType.ChangePage, (Int32) ViewType.FalutHistroyB, 0, 0);
        }
        ...
        void btnPage_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            switch(e.Message)
            {
                ...
                case 1://上一页
                    ...
                    break;
                case 2://下一页
                    if (_currentPage < HD_VC_FalutManager.FalutsAHistroy.Count / 16) _currentPage++;
                    break;
            }
        }
        ...
        public override bool mouseDown(System.Drawing.Point point)
        {
            ...
            _btns[1].MouseDown(point);
            _btnsPage.ForEach(a => a.MouseDown(point));
            _btnsTrain[1].MouseDown(point);
        ...
        public override bool mouseUp(System.Drawing.Point point)
        {
            ...
            _btns[1].MouseUp(point);
            _btnsPage.ForEach(a => a.MouseUp(point));
            _btnsTrain[1].MouseUp(point);
        ...
        void btn_ClickEvent(object sender, ClickEventArgs<int> e)
        {
            ...
            append_postCmd(CmdType.ChangePage, (Int32)ViewType.FalutConveterA, 0, 0);//跳转到主断查询界面
        }
        ...
        private void paint_Frame(Graphics dcGs)
        {
            ...
            dcGs.DrawRectangle(Pens.White, new Rectangle(226, 144, 286, 347));
            dcGs.DrawRectangle(Pens.White, new Rectangle(553, 144, 48, 347));
            dcGs.DrawRectangle(Pens.White, new Rectangle(647, 144, 48, 347));
            dcGs.DrawRectangle(Pens.White, new Rectangle(732, 144, 54, 347));
        ...
        {
            if (HD_VC_FalutManager.FalutsAHistroy == null || HD_VC_FalutManager.FalutsAHistroy.Count == 0)
                return;

            //获取到当前页故障
            List<FalutInfo> histroyFaluts = HD_VC_FalutManager.FalutsAHistroy;
            ...
            for (int i = 0; i < 2; i++)
            {
                Int32 value = i == 0 ? (HD_VC_FalutManager.FalutsAHistroy.Count / 16 + 1) : (_currentPage + 1);
                dcGs.DrawString(
                    value.ToString(),
                    new Font("宋体", 11),
                    Brushes.Yellow,
            ...
            for (int i = 0; i < _currentFalut.Count; i++)
            {
                ...
                //机车速度
                dcGs.DrawString(
                   _currentFalut[i].Speed.ToString("0.0"),
                   new Font("宋体", 9),
                   Brushes.Yellow,
                ...
                //网压
                dcGs.DrawString(
                   _currentFalut[i].Voltage.ToString("0.0"),
                   new Font("宋体", 9),
                   Brushes.Yellow,
                   new RectangleF(_rect[5].X, _rect[5].Y + 43 + 19 * i, _rect[5].Width, 19),
                   new StringFormat() { LineAlignment = StringAlignment.Center, Alignment = StringAlignment.Center }
                   );
                //电流
                dcGs.DrawString(
                   _currentFalut[i].Electric.ToString("0.0"),
                   new Font("宋体", 9),
                   Brushes.Yellow,
                   new RectangleF(_rect[6].X, _rect[6].Y + 43 + 19 * i, _rect[6].Width, 19),
                   new StringFormat() { LineAlignment = StringAlignment.Center, Alignment = StringAlignment.Center }
                   );
                //方向
                dcGs.DrawString(
                   _currentFalut[i].Direction.ToString(),
                   new Font("宋体", 9),
                   Brushes.Yellow,
                   new RectangleF(_rect[7].X, _rect[7].Y + 43 + 19 * i+2, _rect[7].Width, 19),
                   new StringFormat() { LineAlignment = StringAlignment.Center, Alignment = StringAlignment.Center }
                   );
                //级位
                dcGs.DrawString(
                   ...
                   new Font("宋体", 9),
                   Brushes.Yellow,
                   new RectangleF(_rect[8].X, _rect[8].Y + 43 + 19 * i, _rect[8].Width, 19),
                   new StringFormat() { LineAlignment = StringAlignment.Center, Alignment = StringAlignment.Center }
                   );
                //故障级别
                dcGs.DrawString(
                   _currentFalut[i].Grade.ToString(),
                   new Font("宋体", 9),
                   Brushes.Yellow,
                   new RectangleF(_rect[9].X, _rect[9].Y + 43 + 19 * i, _rect[9].Width, 19),
                   new StringFormat() { LineAlignment = StringAlignment.Center, Alignment = StringAlignment.Center }
                   );
            }
        }
