...
{
    public class AYaShuoJ  //¸¨ÖúÑ¹Ëõ»ú
    {
        ...
        public AYaShuoJ(int x, int y, int weight, int height)
        {
        ...
        public void OnDraw(Graphics g)
        {
            switch (S)
            {
                case Status.Working:
                    ...
                    g.DrawString("A", Font,WhiteBrush, Rect.X + 8, Rect.Y + 12);
                    break;
                case Status.Closed:
                    ...
                    g.DrawString("A", Font, GreenBrush, Rect.X + 8, Rect.Y + 12);
                    break;
                case Status.Unknow:
                    ...
                    g.DrawString("A", Font, GrayBrush, Rect.X + 8, Rect.Y + 12);
                    break;
            }
        }
