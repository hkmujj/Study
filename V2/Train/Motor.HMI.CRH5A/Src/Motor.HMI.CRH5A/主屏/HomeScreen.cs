...
namespace Motor.HMI.CRH5A.主屏
{
    ...
    internal class HomeScreen : CRH5ABase
    {
                ...
                m_HomeScreenItemCollection = new List<HomeScreenItem>()
                                             {
                                                 ...
                                                 new HomeScreenItem() { Text = "故障历史", ConfirmSelected = o => append_postCmd(CmdType.ChangePage, 102, 0, 0) },
                                             };
            }
            else
            {
