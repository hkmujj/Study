...
namespace Motor.HMI.CRH5A.密码
{
    [GksDataType(DataType.isMMIObjectClass)]
    internal class PassWord : CRH5ABase 
    {
        ...
        private void DrawOn(Graphics e)
        {
            ...
            e.DrawString("请输入密码", FontsItems.Fonts_Regular(FontName.宋体, 14, false), SolidBrushsItems.RedBrush1,
