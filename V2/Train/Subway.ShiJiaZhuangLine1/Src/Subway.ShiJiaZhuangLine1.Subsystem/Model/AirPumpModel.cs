...
namespace Subway.ShiJiaZhuangLine1.Subsystem.Model
{
    public class AirPumpModel : NotificationObject, IAirPunp
    {
        ...
        public void ChangeBools(CommunicationDataChangedArgs<bool> args)
        {
            ...
            var index4 = IndexConfigure.Instance.IndexFacade.InBoolDictionary[InBoolKeys.Inb车3空气压缩机未知];
            if (args.NewValue.ContainsKey(index1) || args.NewValue.ContainsKey(index2) ||
                args.NewValue.ContainsKey(index3) || args.NewValue.ContainsKey(index4))
            {
                Car3AirPumpStatus = AirPumpStatus.AirClosed;
                ...
                {
                    Car3AirPumpStatus = AirPumpStatus.AirStateUnknown;
                }
            }
            ...
            index4 = IndexConfigure.Instance.IndexFacade.InBoolDictionary[InBoolKeys.Inb车4空气压缩机未知];
            if (args.NewValue.ContainsKey(index1) || args.NewValue.ContainsKey(index2) ||
                args.NewValue.ContainsKey(index3) || args.NewValue.ContainsKey(index4))
            {
                Car4AirPumpStatus = AirPumpStatus.AirClosed;
                ...
                {
                    Car4AirPumpStatus = AirPumpStatus.AirStateUnknown;
                }
            }
        }
