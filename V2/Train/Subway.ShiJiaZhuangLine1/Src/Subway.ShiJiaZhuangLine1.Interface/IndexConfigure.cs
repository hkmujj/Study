...
namespace Subway.ShiJiaZhuangLine1.Interface
{
    public class IndexConfigure
    {
        ...
        const string InBoolConfigFile = "石家庄接口_InBool.xls";
        const string InFloatConfigFile = "石家庄接口_InFloat.xls";
        const string OutBoolConfigFile = "石家庄接口_OutBool.xls";
        const string OutFloatConfigFile = "石家庄接口_OutFloat.xls";
