...
namespace Tram.CBTC.NRIET.Controller.BtnStragy
{
    ...
    public class StateInterfaceFactory : IStateInterfaceFactory
    {
        ...
        private void CreateStateInterface(StateInterfaceKey interfaceKey)
        {
            ...
            if (itConfig != null)
            {
                var state = new StateInterface
                {
                    ...
                    ContentViewName = string.Format("Tram.CBTC.Nriet.View.Contents.{0}", itConfig.ContentViewName),
        ...
        {
            var actionClassFullName = string.Format("Tram.CBTC.Nriet.Controller.BtnActionResponser.{0}",
                actionClassName);
