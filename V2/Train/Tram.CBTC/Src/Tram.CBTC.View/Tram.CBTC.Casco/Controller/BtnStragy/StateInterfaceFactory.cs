...
namespace Tram.CBTC.Casco.Controller.BtnStragy
{
    ...
    public class StateInterfaceFactory : IStateInterfaceFactory
    {
        ...
        private void CreateStateInterface(StateInterfaceKey interfaceKey)
        {
            ...
            if (itConfig != null)
            {
                var state = new StateInterface
                {
                    ...
                    ContentViewName = string.Format("Tram.CBTC.Casco.View.Contents.{0}", itConfig.ContentViewName),
        ...
        {
            var actionClassFullName = string.Format("Tram.CBTC.Casco.Controller.BtnActionResponser.{0}",
                actionClassName);
