...
namespace Tram.CBTC.Casco.Resources.Images.CH
{
    internal static class ImageResCreater
    {
        ...
        {
            var dir =
                Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..\Src\Tram.CBTC.View\Tram.CBTC.Casco\Resources\Images\CH"));

            var format = "<ImageSource x:Key=\"Tram.CBTC.Casco.Images{0}\">CH{1}</ImageSource>\r\n";
