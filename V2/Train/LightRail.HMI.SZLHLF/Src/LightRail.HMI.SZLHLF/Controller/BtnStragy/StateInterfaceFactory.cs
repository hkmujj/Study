...
namespace LightRail.HMI.SZLHLF.Controller.BtnStragy
{
    ...
    public class StateInterfaceFactory : IStateInterfaceFactory
    {
        ...
        private void CreateStateInterface(StateInterfaceKey interfaceKey)
        {
            ...
            if (itConfig != null)
            {
                var state = new StateInterface
                {
                    ...
                    ContentViewName = string.Format("LightRail.HMI.SZLHLF.View.Contents.{0}", itConfig.ContentViewName),
        ...
        {
            var actionClassFullName = string.Format("LightRail.HMI.SZLHLF.Controller.BtnActionResponser.{0}",
                actionClassName);
