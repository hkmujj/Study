...
namespace LightRail.HMI.SZLHLF.Model.BtnStragy
{
    ...
    public class StateInterface : ModelBase, IStateInterface, IRaiseResourceChangedProvider
    {
        ...
        public void UpdateState()
        {
            //try
            //{
            //    m_RegionManager.RequestNavigate(RegionNames.RegionMainContentContent, ContentViewName);
            //}
            //catch (Exception e)
            //{
            //    AppLog.Error("Can not navigate to content view , where regionname ={0}, view name = {1}, {2}",
            //        RegionNames.RegionMainContentContent, ContentViewName, e);
            //}
            BtnB1.UpdateState();
            BtnB2.UpdateState();
            BtnB3.UpdateState();
