...
namespace LightRail.Ethiopia.TMS.MianTain
{
    ...
    public class V804_MianTain_HistoryFaultList : baseClass
    {
        #region 私有变量
        ...
        public override bool init(ref int nErrorObjectIndex)
        {
            ...
            grid = new Grid(
                ...
                new Column[5]
                {
                    new Column()
                    {
                        Width = 62,Font = new Font("Verdana", 9),
                    ...
                    new Column()
                    {
                        Width = 64,Font = new Font("Verdana", 9),
                    ...
                    new Column()
                    {
                        Width = 188,Font = new Font("Verdana", 9),
                        SF=new StringFormat(){Alignment = StringAlignment.Center,LineAlignment = StringAlignment.Center} ,
                        Brush = Brushes.Yellow,
                        LinePen = new Pen(Brushes.Yellow,1)
                    } ,
                    ...
                    new Column()
                    {
                        Width = 378,Font = new Font("Verdana", 9),
                        SF=new StringFormat(){Alignment = StringAlignment.Center,LineAlignment = StringAlignment.Center} ,
                        Brush = Brushes.Yellow,
                        LinePen = new Pen(Brushes.Yellow,1)
                    } 
        ...
        private void paint_Frame(Graphics dcGs)
        {
            ...
            dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(20 + 62, 123), new PointF(20 + 62, 123 + 38));
            dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(20 + 62 + 64, 123), new PointF(20 + 62 + 64, 123 + 38));
            dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(20 + 62 + 64 + 188, 123), new PointF(20 + 62 + 64 + 188, 123 + 38));
            dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(20 + 62 + 64 + 188 + 62, 123), new PointF(20 + 62 + 64 + 188 + 62, 123 + 38));
            dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(20 + 62 + 64 + 188 + 62 + 378, 123), new PointF(20 + 62 + 64 + 188 + 62 + 378, 123 + 38));
            
            dcGs.DrawString(
                "Vehicle",
                new Font("Verdana", 9),
                Brushes.Yellow,
                new RectangleF(20, 123, 62, 38),
            ...
            dcGs.DrawString(
                ...
                new Font("Verdana", 9),
                Brushes.Yellow,
                new RectangleF(20 + 62, 123, 64, 38),
                new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center }
                );
            ...
            dcGs.DrawString(
                ...
                new Font("Verdana", 9),
                Brushes.Yellow,
                new RectangleF(20 + 62 + 64, 123, 188, 38),
                new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center }
                );
            ...
            dcGs.DrawString(
                ...
                new Font("Verdana", 9),
                Brushes.Yellow,
                new RectangleF(20 + 62 + 64 + 188, 123, 62, 38),
                new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center }
                );
            ...
            dcGs.DrawString(
                ...
                new Font("Verdana", 9),
                Brushes.Yellow,
                new RectangleF(20 + 62 + 64 + 188 + 62, 123, 378, 38),
                new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center }
                );
        }
        ...
        {
            if (VC_C4_GetFault.AllFaults == null)
                return;
