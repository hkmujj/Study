...
namespace LightRail.Ethiopia.TMS.Net
{
    ...
    public class V2_Net_C5_Mc2_Down : baseClass
    {
        #region 私有变量
        ...
        public override bool init(ref int nErrorObjectIndex)
        {
            ...
            string[] tmpFile0 = File.ReadAllLines(
                Path.Combine(AppConfig.AppPaths.ConfigDirectory,"Mc2Down模块信息.txt"),
                Encoding.Default
                );
        ...
        {
            getValue();
            paint_Mc1_Down(dcGs, 4, new Rectangle(458+25, 403, 109, 124));
