...
namespace LightRail.Ethiopia.TMS.Net
{
    public class NetInfo
    {
        ...
        public NetInfo(Int32 id, String name)
        {
            ID = id;
            Name = name;
        }
    ...
    public class V2_Net_C1_Mc1_Up : baseClass
    {
        #region 私有变量
        ...
        public override bool init(ref int nErrorObjectIndex)
        {
            ...
            string[] tmpFile0 = File.ReadAllLines(
                Path.Combine(AppConfig.AppPaths.ConfigDirectory,"Mc1Up模块信息.txt"),
                Encoding.Default
                );
        ...
        {
            getValue();
            paint_Mc1(dcGs, 43, -84, 5, new Rectangle(290, 190, 57, 25));
