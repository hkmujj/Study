...
namespace LightRail.Ethiopia.TMS.HVAC
{
    ...
    public class V701_HVAC_State : baseClass
    {
        #region 私有变量
        ...
        public override bool init(ref int nErrorObjectIndex)
        {
            ...
            {
                //第一页
                new List<object>(){"evapraor fan status",null,null},
                new List<object>(){"condenser fan status",null,null},
                new List<object>(){"compressor1 status",null,null},
                new List<object>(){"heater1 status",null,null},
                new List<object>(){"compressor2 status",null,null},
                new List<object>(){"heater2 status",null,null},
                new List<object>(){"auto-Warm mode",null,null},
                new List<object>(){"auto-Cold mode",null,null},
                new List<object>(){"ventilation mode",null,null},
                new List<object>(){"emergency ventilation mode",null,null},
                new List<object>(){"stop mode",null,null},

                //第二页
                new List<object>(){"Reduce_Load_FB",null,null},
                new List<object>(){"Pre-Cold",null,null},
                new List<object>(){"Pre-Warm",null,null},
                new List<object>(){"fresh air damper status",null,null},
                new List<object>(){"return air damper status",null,null},
                new List<object>(){"Half Cold Mode",null,null},
                new List<object>(){"Full Cold Mode",null,null},
                new List<object>(){"Half Warm Mode",null,null},
                new List<object>(){"Full Warm Mode",null,null},
                new List<object>(){"Temp_Outside",0,0},
                new List<object>(){"Temp_Outside",0,0}
            };

            grid = new Grid(
                new RectangleF(62, 150 + 28, 662, 364 - 28 - 28),
                new Row[11],
                new Column[3]
                {
                    new Column()
        ...
        private void paint_Frame(Graphics dcGs)
        {
            ...
            dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(62, 150 + 28 * 12), new PointF(62, 150 + 28 * 13));
            dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(62, 150 + 28 * 13), new PointF(724, 150 + 28 * 13));

            for (int i = 0; i < 3; i++)
            {
                dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(452 + 136 * i, 150), new PointF(452 + 136 * i, 150 + 28 * 13));
                dcGs.DrawLine(new Pen(new SolidBrush(Color.Yellow), 1), new PointF(452 + 136 * i, 150), new PointF(452 + 136 * i, 150 + 28 * 13));
            }
        ...
        private void getValue()
        {
            ...
            {
                _values[i / 2 + 20][i % 2 + 1] = FloatList[UIObj.InFloatList[0] + i];
            }
        }
    }
}
