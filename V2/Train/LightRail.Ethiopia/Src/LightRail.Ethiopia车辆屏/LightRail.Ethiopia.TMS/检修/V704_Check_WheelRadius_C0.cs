...
namespace LightRail.Ethiopia.TMS.检修
{
    ...
    public class V704_Check_WheelRadius_C0 : baseClass
    {
        ...
        public override bool mouseDown(Point nPoint)
        {
            ...
            _btns_Train.ForEach(a => a.MouseDown(nPoint));
        ...
        public override bool mouseUp(Point nPoint)
        {
            ...
            _btns_Train.ForEach(a => a.MouseUp(nPoint));
        ...
        public override void paint(Graphics dcGs)
        {
            ...
            _btns_Train.ForEach(a => a.Paint(dcGs));
            paint_SetValue(dcGs);
        ...
        private void paint_SetValue(Graphics dcGs)
        {
            ...
            String[] str_ = new String[] { _oldWheelRadius, _newWheelRadius };
            for (int i = 0; i < 2; i++)
            {
