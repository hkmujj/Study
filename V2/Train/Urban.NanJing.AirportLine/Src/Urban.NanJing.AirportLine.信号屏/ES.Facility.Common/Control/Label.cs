...
namespace ES.Facility.Common.Control
{
    ...
    public class Label : IControl
    {
        ...
        public void Paint(Graphics g)
        {
            ...
            {
                g.DrawRectangle(((LabelStyle)m_Style).BorderPen, m_Rect.X, m_Rect.Y, m_Rect.Width, m_Rect.Height);
                if (((LabelStyle)m_Style).Background != null)
                {
                    g.DrawImage(((LabelStyle)m_Style).Background, new RectangleF(m_Rect.X + 1, m_Rect.Y + 1, m_Rect.Width - 1, m_Rect.Height - 1));
                }
                else if (((LabelStyle)m_Style).BackgroundBrush != null)
                {
                    g.FillRectangle(((LabelStyle)m_Style).BackgroundBrush, new RectangleF(m_Rect.X + 1, m_Rect.Y + 1, m_Rect.Width - 1, m_Rect.Height - 1));
                }
            }
            else
            {
                if (((LabelStyle)m_Style).Background != null)
                {
                    g.DrawImage(((LabelStyle)m_Style).Background, m_Rect);
                }
                else if (((LabelStyle)m_Style).BackgroundBrush != null)
                {
                    g.FillRectangle(((LabelStyle)m_Style).BackgroundBrush, m_Rect);
                }
            }
