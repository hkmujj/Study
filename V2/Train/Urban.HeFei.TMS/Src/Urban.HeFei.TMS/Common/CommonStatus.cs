...
namespace Urban.HeFei.TMS.Common
{
    ...
    public class CommonStatus
    {
        ...
        /// 向外发送bool数据时计数开始位
        /// </summary>
        public static readonly int SdBoolBaseNumber = 1600;

        /// <summary>
        /// 向外发送float数据时计数开始位
        /// </summary>
        public static readonly int SdFloatBaseNumber = 200;
        ...
        static CommonStatus()
        {
            ...
            InterfaceNameDicts.Add(ViewState.Traction, "牵引");
            ...
            InterfaceNameDicts.Add(ViewState.History, "历史");
