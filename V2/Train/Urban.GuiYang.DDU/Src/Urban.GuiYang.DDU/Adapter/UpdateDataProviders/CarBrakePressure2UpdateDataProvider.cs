...
namespace Urban.GuiYang.DDU.Adapter.UpdateDataProviders
{
    ...
    public class CarBrakePressure2UpdateDataProvider : UpdateDataProviderBase
    {
        ...
        {
            var doors = ViewModel.TrainViewModel.Model.CarCollection.Select(s => s.Brake.BrakePage2.Value.BrakePressure2).Where(w => !string.IsNullOrWhiteSpace(w.ItemConfig.Branch2UnkownIndex));
