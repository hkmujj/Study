...
namespace Urban.GuiYang.DDU.Model.BtnStragy
{
    ...
    public class BtnItem : NotificationObject, IRaiseResourceChangedProvider
    {
        ...
        public BtnItem(string content, IBtnActionResponser actionResponser, IBtnStateProvider stateProvider)
        {
            Content = content;
        ...
        public IBtnStateProvider StateProvider { get; private set; }
