...
{
    [Export]
    class AutoSpeedControlMaxSpeedActionResponser : BtnActionResponserBase
    {
         /// <summary>
         /// 响应按键
         /// </summary>
        public override void ResponseClick(StateViewModel stateViewModel)
        {
            ...
            EventAggregator.GetEvent<SendDataRequestEvent>().Publish(new SendDataRequestEvent.Args(OutBoolKeys.Oub最大速度, true));
            ...
            stateViewModel.DomainViewModel.Domain.Model.MainData.AutoSpeedControlType = AutoSpeedControlType.MaxSpeed;
        }
    }
}
