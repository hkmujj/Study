...
{
    [Export]
    class AutoSpeedControlAscCloseActionResponser : BtnActionResponserBase
    {
         /// <summary>
         /// 响应按键
         /// </summary>
        public override void ResponseClick(StateViewModel stateViewModel)
        {
            ...
            stateViewModel.DomainViewModel.Domain.Model.MainData.AutoSpeedControlType = AutoSpeedControlType.AscCloes;
        }
    }
}
