...
{
    [Export]
    class TrianPipeFillWithWindActionResponser : BtnActionResponserBase
    {
        public override void ResponseClick(StateViewModel stateViewModel)
        {

            if (stateViewModel.DomainViewModel.Domain.Model.BrakeModel.BrakeFunctionStatusModel.IsTrianPipeFillWithWindEfficence == Efficence.Efficent)
            {
                stateViewModel.DomainViewModel.Domain.Model.BrakeModel.BrakeFunctionStatusModel.IsTrianPipeFillWithWindEfficence = Efficence.NotEfficent;
            ...
            {
                stateViewModel.DomainViewModel.Domain.Model.BrakeModel.BrakeFunctionStatusModel.IsTrianPipeFillWithWindEfficence = Efficence.Efficent;
                if (stateViewModel.DomainViewModel.Domain.Model.BrakeModel.BrakeFunctionStatusModel.IsAirCompressorEfficence == Efficence.NotEfficent)
                {
                    if (stateViewModel.DomainViewModel.Domain.Model.BrakeModel.BrakeFunctionStatusModel.IsSandDryEfficence == Efficence.NotEfficent)
                    {
