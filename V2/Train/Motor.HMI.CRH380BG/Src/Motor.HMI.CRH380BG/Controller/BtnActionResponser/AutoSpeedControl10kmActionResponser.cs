...
{
    [Export]
    class AutoSpeedControl10kmActionResponser : BtnActionResponserBase
    {
         /// <summary>
         /// 响应按键
         /// </summary>
        public override void ResponseClick(StateViewModel stateViewModel)
        {
            ...
            EventAggregator.GetEvent<SendDataRequestEvent>().Publish(new SendDataRequestEvent.Args(OutBoolKeys.Oub自动速度控制_10kmh, true));
            ...
            stateViewModel.DomainViewModel.Domain.Model.MainData.AutoSpeedControlType = AutoSpeedControlType.Speed10;
        }
    }
}
