...
{
    [Export]
    class ChangeToNetworkCurrentLimit600AActionResponser : BtnActionResponserBase
    {
        public override void ResponseClick(StateViewModel stateViewModel)
        {
            if (stateViewModel.DomainViewModel.Domain.Model.Switch.NetWorkCurrentLimitEnable)
            {
                ...
                EventAggregator.GetEvent<SendDataRequestEvent>().Publish(new SendDataRequestEvent.Args(OutBoolKeys.Oub网侧电流限制_最大, true));

                stateViewModel.DomainViewModel.Domain.Model.Switch.NetWorkCurrentLimitType = NetWorkCurrentLimitType.Current600A;
                ...
                stateViewModel.DomainViewModel.Domain.Model.MainData.NetCurrent600AVisible = true;
            }
        }
    }
}
