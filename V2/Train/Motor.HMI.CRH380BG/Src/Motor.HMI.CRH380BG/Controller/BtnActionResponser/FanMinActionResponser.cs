...
{
    [Export]
    class FanMinActionResponser : BtnActionResponserBase
    {
        /// <summary>
        /// 响应按键
        /// </summary>
        ...
        {
            EventAggregator.GetEvent<SendDataRequestEvent>().Publish(new SendDataRequestEvent.Args(OutBoolKeys.Oub风扇_最小, true));
            ...
            stateViewModel.DomainViewModel.Domain.Model.Switch.FanType = FanType.Min;
        }
    }
}
