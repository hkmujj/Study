...
namespace Motor.HMI.CRH380BG.Model.Common
{
    ...
    public class PageWrapper<T> : NotificationObject where T : class
    {
        ...
        [DebuggerStepThrough]
        public PageWrapper(int countPerPage, Func<T,int, bool> predicate = null, bool addNullToFillPage = false)
        {
            CountPerPage = countPerPage;
            m_AddNullToFillPage = addNullToFillPage;
            if (predicate == null)
            {
                predicate = (it, indx) => true;
        ...
        public Func<T,int, bool> Predicate { private set; get; }
