...
{
    public class LightBushConverter : IValueConverter
    {
        /// <summary>
        /// 转换值。
        /// </summary>
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var tmpValue = 100 - (double)value;

            var result = new SolidColorBrush(Color.FromArgb(System.Convert.ToByte(tmpValue), 0, 0, 0));
