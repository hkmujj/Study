...
{
    public class SubtractionConverter : IValueConverter, IMultiValueConverter
    {
        /// <summary>转换值。</summary>
        ...
        {
            return Convert(new object[] {System.Convert.ToDouble(value), System.Convert.ToDouble(parameter)}, targetType,
                parameter, culture);
        }
