...
{
    public class BrakeCylinderViewValueDialPlate 
        //: IValueDialPlate
    {
        public static readonly TotalWindCylinderViewValueDialPlate Instance = TotalWindCylinderViewValueDialPlate.Instance;
        //public static readonly BrakeCylinderViewValueDialPlate Instance = new BrakeCylinderViewValueDialPlate();

        //public ReadOnlyCollection<IValueDialPlateDegree> AllValueDegrees { get; private set; }

        //private BrakeCylinderViewValueDialPlate()
        //{
