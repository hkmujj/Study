...
{
    [Export]
    public class ChangeToMonitorOilEnginStartActionResponser : BtnActionResponserBase
    {
        /// <summary>
        /// 响应按键
        /// </summary>
        public override void ResponseClick()
        {
            RegionManager.RequestNavigate(RegionNames.ContentMonitorContent,
                typeof(MonitorOilEnginStartContentView).FullName);
            NavigateTo(StateKeys.Root_监控器柴油机启动);
        }
    }
}