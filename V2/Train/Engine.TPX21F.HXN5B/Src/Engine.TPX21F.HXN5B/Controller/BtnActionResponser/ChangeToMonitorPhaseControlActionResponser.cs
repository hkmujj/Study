...
{
    [Export]
    public class ChangeToMonitorPhaseControlActionResponser : BtnActionResponserBase
    {
        /// <summary>
        /// 响应按键
        /// </summary>
        public override void ResponseClick()
        {
            RegionManager.RequestNavigate(RegionNames.ContentMonitorContent,
                typeof(MonitorPhaseControlContentView).FullName);
            NavigateTo(StateKeys.Root_监控器相控);
        }
    }
}