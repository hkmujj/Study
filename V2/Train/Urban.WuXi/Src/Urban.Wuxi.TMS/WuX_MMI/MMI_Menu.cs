...
namespace KumM_MMI.MMI_Message
{
    ...
    /// </summary>
    [GksDataType(MMI.Facility.Interface.Attribute.DataType.isMMIObjectClass)]
    public class MMIBlackScreen_Closed : baseClass
    {
        #region :::::::::::::::::::::::::: init override :::::::::::::::::::::::::
        //2
        public override string GetInfo()
        ...
        private void InitData()
        {
            ...
            RightFormat.LineAlignment = (StringAlignment)2;
            RightFormat.Alignment = (StringAlignment)1;

            LeftFormat.LineAlignment = (StringAlignment)0;
            LeftFormat.Alignment = (StringAlignment)1;
        }
        #endregion
