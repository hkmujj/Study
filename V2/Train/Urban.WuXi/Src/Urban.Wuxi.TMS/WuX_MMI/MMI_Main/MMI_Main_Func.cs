...
namespace KumM_MMI
{
    public partial class MMI_Main : baseClass
    {
        ...
        {
            driveTime = Convert.ToInt32(time).ToString();

            if (driveTime.Length == 5)
                driveTime = driveTime.Insert(0, "0");
            if (driveTime.Length == 6)
            {
                return driveTime[0].ToString() + driveTime[1].ToString()
                    + " : " + driveTime[2].ToString() + driveTime[3].ToString()
                    + " : " + driveTime[4].ToString() + driveTime[5].ToString();
            }
            else
                return "";
        }
