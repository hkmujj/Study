...
namespace SS4B_TMS.Common
{
    ...
    {
        public static StringFormat SfCc = new StringFormat
        {
            Alignment = StringAlignment.Center,
            LineAlignment = StringAlignment.Center
        };

        public static StringFormat SfCt = new StringFormat
        {
            Alignment = StringAlignment.Center,
            LineAlignment = StringAlignment.Near
        };

        public static StringFormat SfCb = new StringFormat
        {
            Alignment = StringAlignment.Center,
        ...
        public static StringFormat SfLt = new StringFormat
        {
            Alignment = StringAlignment.Near,
            LineAlignment = StringAlignment.Near
        };

        public static StringFormat SfRc = new StringFormat
        {
            Alignment = StringAlignment.Far,
            LineAlignment = StringAlignment.Center
        };

        public static StringFormat SfLb = new StringFormat
        {
            Alignment = StringAlignment.Near,
            LineAlignment = StringAlignment.Far
        };
