...
namespace Subway.TCMS.LanZhou.Model.BtnStragy
{
    ...
    public class StateInterface : NotificationObject, IStateInterface
    {
        ...
        private BtnType m_CurrentSelectedBtn;
        ...
        public BtnType CurrentSelectedBtn
        {
            get { return m_CurrentSelectedBtn; }
            set
            {
                if (value == m_CurrentSelectedBtn)
                {
                    return;
                }

                m_CurrentSelectedBtn = value;
                RaisePropertyChanged(() => CurrentSelectedBtn);
            }
        }
