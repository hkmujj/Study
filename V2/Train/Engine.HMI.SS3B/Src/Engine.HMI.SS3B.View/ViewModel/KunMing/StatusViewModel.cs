...
namespace Engine.HMI.SS3B.View.ViewModel.KunMing
{
    ...
    public class StatusViewModel : ViewModelBase
    {
        ...
        private double m_ReconnexionOther;
        private double m_ReconnexionOrgin;
        private double m_StandAloneRunOther;
        private double m_StandAloneRunOrigin;
        ...
        public double StandAloneRunOrigin
        {
            get { return m_StandAloneRunOrigin; }
            set
            {
                if (value.Equals(m_StandAloneRunOrigin))
                {
                    return;
                }
                m_StandAloneRunOrigin = value;
                RaisePropertyChanged(() => StandAloneRunOrigin);
            }
        }

        public double StandAloneRunOther
        {
            get { return m_StandAloneRunOther; }
            set
            {
                if (value.Equals(m_StandAloneRunOther))
                {
                    return;
                }
                m_StandAloneRunOther = value;
                RaisePropertyChanged(() => StandAloneRunOther);
            }
        }

        public double ReconnexionOrgin
        {
            get { return m_ReconnexionOrgin; }
            set
            {
                if (value.Equals(m_ReconnexionOrgin))
                {
                    return;
                }
                m_ReconnexionOrgin = value;
                RaisePropertyChanged(() => ReconnexionOrgin);
            }
        }

        public double ReconnexionOther
        {
            get { return m_ReconnexionOther; }
            set
            {
                if (value.Equals(m_ReconnexionOther))
                {
                    return;
                }
                m_ReconnexionOther = value;
                RaisePropertyChanged(() => ReconnexionOther);
            }
        }
