...
namespace Engine.HMI.SS3B.View.ViewModel.KunMing
{
    ...
    public class MainCircuitPageViewModel : ViewModelBase
    {
        ...
        private double m_MasterOpenOther;
        private double m_MasterOpenOrigin;
        private double m_NetPressTwoOrigin;
        private double m_NetPressOneOrigin;
        private double m_NetPressTwoOther;
        private double m_NetPressOneOther;
        private double m_MagicOther;
        private double m_LevelOther;
        private double m_MagicOrigin;
        private double m_LevelOrigin;
        ...
        public double MasterOpenOther
        {
            get { return m_MasterOpenOther; }
            set
            {
                if (value.Equals(m_MasterOpenOther))
                {
                    return;
                }
                m_MasterOpenOther = value;
                RaisePropertyChanged(() => MasterOpenOther);
            }
        }

        public double MasterOpenOrigin
        {
            get { return m_MasterOpenOrigin; }
            set
            {
                if (value.Equals(m_MasterOpenOrigin))
                {
                    return;
                }
                m_MasterOpenOrigin = value;
                RaisePropertyChanged(() => MasterOpenOrigin);
            }
        }
        ...
        public double NetPressOneOther
        {
            get { return m_NetPressOneOther; }
            set
            {
                if (value.Equals(m_NetPressOneOther))
                {
                    return;
                }
                m_NetPressOneOther = value;
                RaisePropertyChanged(() => NetPressOneOther);
            }
        }

        public double NetPressTwoOther
        {
            get { return m_NetPressTwoOther; }
            set
            {
                if (value.Equals(m_NetPressTwoOther))
                {
                    return;
                }
                m_NetPressTwoOther = value;
                RaisePropertyChanged(() => NetPressTwoOther);
            }
        }

        public double NetPressOneOrigin
        {
            get { return m_NetPressOneOrigin; }
            set
            {
                if (value.Equals(m_NetPressOneOrigin))
                {
                    return;
                }
                m_NetPressOneOrigin = value;
                RaisePropertyChanged(() => NetPressOneOrigin);
            }
        }

        public double NetPressTwoOrigin
        {
            get { return m_NetPressTwoOrigin; }
            set
            {
                if (value.Equals(m_NetPressTwoOrigin))
                {
                    return;
                }
                m_NetPressTwoOrigin = value;
                RaisePropertyChanged(() => NetPressTwoOrigin);
            }
        }

        public double LevelOrigin
        {
            get { return m_LevelOrigin; }
            set
            {
                if (value.Equals(m_LevelOrigin))
                {
                    return;
                }
                m_LevelOrigin = value;
                RaisePropertyChanged(() => LevelOrigin);
            }
        }

        public double MagicOrigin
        {
            get { return m_MagicOrigin; }
            set
            {
                if (value.Equals(m_MagicOrigin))
                {
                    return;
                }
                m_MagicOrigin = value;
                RaisePropertyChanged(() => MagicOrigin);
            }
        }

        public double LevelOther
        {
            get { return m_LevelOther; }
            set
            {
                if (value.Equals(m_LevelOther))
                {
                    return;
                }
                m_LevelOther = value;
                RaisePropertyChanged(() => LevelOther);
            }
        }

        public double MagicOther
        {
            get { return m_MagicOther; }
            set
            {
                if (value.Equals(m_MagicOther))
                {
                    return;
                }
                m_MagicOther = value;
                RaisePropertyChanged(() => MagicOther);
            }
        }
    }
}
