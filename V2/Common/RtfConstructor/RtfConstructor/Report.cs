...
using RtfConstructor.Properties;
...
namespace RtfConstructor
{
    public class Report
    {
        ...
        private static void Test()
        {
            ...
            rtf.ColorTable.Add(new RtfColor(Color.Red));
            RtfFormattedParagraph p2 = new RtfFormattedParagraph
            {
                Formatting = new RtfParagraphFormatting(18, RtfTextAlign.Left)
                {
                    LineSpacingPercent = 10
                }
            };
            p2.AppendText(new RtfTabCharacter());
            p2.AppendText(new RtfFormattedText("请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你请你",10)
            {
                
            });
            rtf.Contents.Add(p2);

            using (TextWriter writer = new StreamWriter("d:\\c.rtf"))
            {
        ...
        public Report()
        {
            ...
            RtfImage picture = new RtfImage(Resources.lemon, RtfImageFormat.Wmf);
            picture.ScaleX = 50;
            picture.ScaleY = 50;
