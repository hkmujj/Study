...
namespace CommonUtil.Rtf
{
    ...
    /// </summary>
    public class RtfDocumentContentCollection : ICollection<RtfDocumentContentBase>, IEnumerable<RtfDocumentContentBase>
    {
        private RtfDocument Document;
        private List<RtfDocumentContentBase> list;
