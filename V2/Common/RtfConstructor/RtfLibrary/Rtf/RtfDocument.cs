...
namespace CommonUtil.Rtf
{
    ...
    {
        [RtfControlWord]
        public RtfDocumentCharacterSet CharSet { get; set; }

        [RtfControlWord]
        public RtfCodePage CodePage { get; set; }
        ...
        public RtfLanguage DefaultLanguage { get; set; }

        [RtfControlGroup("fonttbl"), RtfInclude(ConditionMember = "FontTableIsNotEmpty")]
        public RtfFontCollection FontTable { get; private set; }

        [RtfControlGroup("colortbl")]
        public RtfColorCollection ColorTable { get; private set; }

        [RtfInclude]
        public RtfDocumentContentCollection Contents { get; private set; }
        ...
        public RtfDocument()
        {
            ColorTable = new RtfColorCollection();
            FontTable = new RtfFontCollection();
            DefaultLanguage = RtfLanguage.EnglishUnitedStates;
            CodePage = RtfCodePage.WesternEuropean;
            CharSet = RtfDocumentCharacterSet.ANSI;
